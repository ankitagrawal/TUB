...
public class JitShippingOrderPOCreationServiceImpl implements JitShippingOrderPOCreationService {
    ...
    private ShippingOrderSearchCriteria getShippingOrderSearchCriteria(boolean filterJit) {
    ...
    private HashMap<PurchaseOrder, Set<ProductVariantMrpQtyLineItems>> createPurchaseOrderVariantMrpQuantityMap(
    ...
    private void createPurchaseOrdersForVariedMrp(PurchaseOrder purchaseOrder, Set<ProductVariantMrpQtyLineItems> productVariantMrpQtyLineItems) {
    ...
    private PurchaseOrder createPO(Supplier supplier, Warehouse warehouse) {
    ...
    private void createPOLineItemsForPO(PurchaseOrder purchaseOrder, Set<ProductVariantMrpQtyLineItems> items, Set<ShippingOrder> shippingOrders) {
    ...
    private Supplier getBrightSupplierForAquaWH(Warehouse warehouse) {
