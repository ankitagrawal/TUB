...
public class AccountingInvoicePdfGenerator {
  ...
  private void addOrderDetailsContent(Document document, ShippingOrder shippingOrder, B2bUserDetails b2bUserDetails, InvoiceDto invoiceDto)
    ...
    if (b2bUserDetails != null) {
      String tinNumber = invoiceDto.getB2bUserDetails().getTin();
      if (stateName.equalsIgnoreCase("HARYANA") && tinNumber != null) {
        invoiceHeading = TAX_INVOICE;
      } else if (stateName.equalsIgnoreCase("MAHARASHTRA") && tinNumber != null) {
        invoiceHeading = TAX_INVOICE;
      } else {
        invoiceHeading = RETAIL_INVOICE;
      }
    } else {
      invoiceHeading = RETAIL_INVOICE;
    }*/
    Paragraph preface = new Paragraph();
    Paragraph header = new Paragraph(invoiceDto.getAccountingInvoiceHeading(), new Font(Font.FontFamily.TIMES_ROMAN, 16,
        Font.NORMAL));
  ...
  private void createAddrssDetailTable(Document document, ShippingOrder shippingOrder, InvoiceDto invoiceDto)
    ...
    if (warehouseState.equalsIgnoreCase("MAHARASHTRA")) {
      tinNumber = "TIN# 27210893736";
    }*/

    //Address paragraph
    if (invoiceDto.getB2bUserDetails() != null) {
      addressParagraph.add(new Paragraph("BrightLifecare Pvt Ltd.", new Font(Font.FontFamily.TIMES_ROMAN, 8,
          Font.NORMAL)));
      addressParagraph.add(new Paragraph("3rd Floor, Parshavnath Arcadia,", new Font(Font.FontFamily.TIMES_ROMAN, 8,
          Font.NORMAL)));
      addressParagraph.add(new Paragraph("1, MG Road, Gurgaon, Haryana - 122001", new Font(Font.FontFamily.TIMES_ROMAN, 8,
          Font.NORMAL)));
      addressParagraph.add(new Paragraph(invoiceDto.getInvoiceTinNumber(), new Font(Font.FontFamily.TIMES_ROMAN, 8,
          Font.NORMAL)));
      addressParagraph.add(new Paragraph(invoiceDto.getInvoiceDLnumber(), new Font(Font.FontFamily.TIMES_ROMAN, 8,
          Font.NORMAL)));
    } else {
      addressParagraph.add(new Paragraph("Aquamarine HealthCare Pvt. Ltd.", new Font(Font.FontFamily.TIMES_ROMAN, 8,
          Font.NORMAL)));
      addressParagraph.add(new Paragraph("3rd Floor, Parshavnath Arcadia,", new Font(Font.FontFamily.TIMES_ROMAN, 8,
          Font.NORMAL)));
      addressParagraph.add(new Paragraph("1, MG Road, Gurgaon, Haryana 122001", new Font(Font.FontFamily.TIMES_ROMAN, 8,
    ...
    invoiceDetailParagraph.add(new Paragraph("Invoice#:" + invoiceDto.getInvoiceType() + "-" + invoiceNumString, new Font(Font.FontFamily.TIMES_ROMAN, 8,
        Font.NORMAL)));
    invoiceDetailParagraph.add(new Paragraph("Invoice Date:" + shipmentDateString, new Font(Font.FontFamily.TIMES_ROMAN, 8,
        Font.NORMAL)));
    ...
    customerAddressParagraph.add(new Paragraph("Customer:" + shippingOrder.getBaseOrder().getAddress().getName(), new Font(Font.FontFamily.TIMES_ROMAN, 8,
        Font.NORMAL)));
    customerAddressParagraph.add(new Paragraph(shippingOrder.getBaseOrder().getAddress().getLine1(), new Font(Font.FontFamily.TIMES_ROMAN, 8,
        Font.NORMAL)));
    if (shippingOrder.getBaseOrder().getAddress().getLine2() != null) {
      customerAddressParagraph.add(new Paragraph(shippingOrder.getBaseOrder().getAddress().getLine2(), new Font(Font.FontFamily.TIMES_ROMAN, 8,
          Font.NORMAL)));
    }
    customerAddressParagraph.add(new Paragraph(shippingOrder.getBaseOrder().getAddress().getCity() + "," + shippingOrder.getBaseOrder().getAddress().getState()
        + "-" + shippingOrder.getBaseOrder().getAddress().getPin(), new Font(Font.FontFamily.TIMES_ROMAN, 8,
        Font.NORMAL)));
    customerAddressParagraph.add(new Paragraph("Ph:" + shippingOrder.getBaseOrder().getAddress().getPhone(), new Font(Font.FontFamily.TIMES_ROMAN, 8,
        Font.NORMAL)));

    if (invoiceDto.getB2bUserDetails() != null) {
      if (invoiceDto.getB2bUserDetails().getTin() != null) {
        customerAddressParagraph.add(new Paragraph("TIN-" + invoiceDto.getB2bUserDetails().getTin(), new Font(Font.FontFamily.TIMES_ROMAN, 8,
            Font.NORMAL)));

      }
      if (invoiceDto.getB2bUserDetails().getDlNumber() != null) {
        customerAddressParagraph.add(new Paragraph("DL Number-" + invoiceDto.getB2bUserDetails().getDlNumber(), new Font(Font.FontFamily.TIMES_ROMAN, 8,
            Font.NORMAL)));
      }
    }
  ...
  private void createInvoiceDetailTable(Document document, InvoiceDto invoiceDto)
      throws BadElementException, DocumentException {
    double rate = 0.0;
    double taxable = 0.0;
    double tax = 0.0;
    ...
    PdfPCell c1 = new PdfPCell(new Phrase("Item", new Font(Font.FontFamily.TIMES_ROMAN, 10,
        Font.BOLD)));
    c1.setHorizontalAlignment(Element.ALIGN_CENTER);
    invoiceDetailTable.addCell(c1);

    c1 = new PdfPCell(new Phrase("Qty", new Font(Font.FontFamily.TIMES_ROMAN, 10,
        Font.BOLD)));
    c1.setHorizontalAlignment(Element.ALIGN_CENTER);
    invoiceDetailTable.addCell(c1);

    c1 = new PdfPCell(new Phrase("Rate (per unit)", new Font(Font.FontFamily.TIMES_ROMAN, 10,
        Font.BOLD)));
    c1.setHorizontalAlignment(Element.ALIGN_CENTER);
    invoiceDetailTable.addCell(c1);

    c1 = new PdfPCell(new Phrase("Tax Rate", new Font(Font.FontFamily.TIMES_ROMAN, 10,
        Font.BOLD)));
    c1.setHorizontalAlignment(Element.ALIGN_CENTER);
    invoiceDetailTable.addCell(c1);

    c1 = new PdfPCell(new Phrase("Taxable", new Font(Font.FontFamily.TIMES_ROMAN, 10,
        Font.BOLD)));
    c1.setHorizontalAlignment(Element.ALIGN_CENTER);
    invoiceDetailTable.addCell(c1);

    c1 = new PdfPCell(new Phrase("Tax", new Font(Font.FontFamily.TIMES_ROMAN, 10,
        Font.BOLD)));
    c1.setHorizontalAlignment(Element.ALIGN_CENTER);
    invoiceDetailTable.addCell(c1);

    c1 = new PdfPCell(new Phrase("Surcharge", new Font(Font.FontFamily.TIMES_ROMAN, 10,
        Font.BOLD)));
    c1.setHorizontalAlignment(Element.ALIGN_CENTER);
    invoiceDetailTable.addCell(c1);
    ...
    if (!invoiceLineItems.isEmpty()) {
      ...
      for (InvoiceLineItemDto invoiceLineItemDto : invoiceLineItems) {
        ...
        invoiceDetailTable.addCell(new PdfPCell(new Phrase(itemDetail.toString(), new Font(Font.FontFamily.TIMES_ROMAN, 10,
            Font.ITALIC))));
        invoiceDetailTable.addCell(new PdfPCell(new Phrase("" + invoiceLineItemDto.getQty(), new Font(Font.FontFamily.TIMES_ROMAN, 10,
            Font.NORMAL))));
        invoiceDetailTable.addCell(new PdfPCell(new Phrase("" + rate, new Font(Font.FontFamily.TIMES_ROMAN, 10,
            Font.NORMAL))));
        invoiceDetailTable.addCell(new PdfPCell(new Phrase(invoiceLineItemDto.getTaxRate(), new Font(Font.FontFamily.TIMES_ROMAN, 10,
            Font.NORMAL))));
        invoiceDetailTable.addCell(new PdfPCell(new Phrase("" + taxable, new Font(Font.FontFamily.TIMES_ROMAN, 10,
            Font.NORMAL))));
        invoiceDetailTable.addCell(new PdfPCell(new Phrase("" + tax, new Font(Font.FontFamily.TIMES_ROMAN, 10,
            Font.NORMAL))));
        invoiceDetailTable.addCell(new PdfPCell(new Phrase("" + surcharge, new Font(Font.FontFamily.TIMES_ROMAN, 10,
            Font.NORMAL))));
      }
    }
    ...
    totalCell.addElement(new Phrase("Total", new Font(Font.FontFamily.TIMES_ROMAN, 10,
        Font.BOLD)));
    invoiceDetailTable.addCell(totalCell);
    invoiceDetailTable.addCell(new PdfPCell(new Phrase("" + totalTaxable, new Font(Font.FontFamily.TIMES_ROMAN, 10,
        Font.NORMAL))));
    invoiceDetailTable.addCell(new PdfPCell(new Phrase("" + totalTax, new Font(Font.FontFamily.TIMES_ROMAN, 10,
        Font.NORMAL))));
    invoiceDetailTable.addCell(new PdfPCell(new Phrase("" + totalSurcharge, new Font(Font.FontFamily.TIMES_ROMAN, 10,
        Font.NORMAL))));
    document.add(invoiceDetailTable);

  }

  private void createTotalSummaryTable(Document document, InvoiceDto invoiceDto)
      throws BadElementException, DocumentException {
    ...
    totalSummaryTable.addCell(new PdfPCell(new Phrase("Shipping cost", new Font(Font.FontFamily.TIMES_ROMAN, 10,
        Font.BOLD))));
    totalSummaryTable.addCell(new PdfPCell(new Phrase(" " + shippingCost, new Font(Font.FontFamily.TIMES_ROMAN, 10,
        Font.NORMAL))));
    totalSummaryTable.addCell(new PdfPCell(new Phrase("Cod Cost", new Font(Font.FontFamily.TIMES_ROMAN, 10,
        Font.BOLD))));
    totalSummaryTable.addCell(new PdfPCell(new Phrase(" " + codCharges, new Font(Font.FontFamily.TIMES_ROMAN, 10,
        Font.NORMAL))));
    totalSummaryTable.addCell(new PdfPCell(new Phrase("Grand Total", new Font(Font.FontFamily.TIMES_ROMAN, 10,
        Font.BOLD))));
    totalSummaryTable.addCell(new PdfPCell(new Phrase(" " + grandTotal, new Font(Font.FontFamily.TIMES_ROMAN, 10,
        Font.NORMAL))));
    document.add(totalSummaryTable);

  }

  private void createTaxSummaryTable(Document document, InvoiceDto invoiceDto)
      throws BadElementException, DocumentException {
    double amount = 0.0;
    double taxOnAmt = 0.0;
    double surcharge = 0.0;
    ...
    Paragraph headingPara = new Paragraph(new Phrase("Tax Summary", new Font(Font.FontFamily.TIMES_ROMAN, 10,
        Font.BOLD)));
    ...
    taxSummaryTable.addCell(new PdfPCell(new Phrase("VAT Percent", new Font(Font.FontFamily.TIMES_ROMAN, 10,
        Font.BOLD))));
    taxSummaryTable.addCell(new PdfPCell(new Phrase("Qty", new Font(Font.FontFamily.TIMES_ROMAN, 10,
        Font.BOLD))));
    taxSummaryTable.addCell(new PdfPCell(new Phrase("Amount", new Font(Font.FontFamily.TIMES_ROMAN, 10,
        Font.BOLD))));
    taxSummaryTable.addCell(new PdfPCell(new Phrase("Tax on Amount", new Font(Font.FontFamily.TIMES_ROMAN, 10,
        Font.BOLD))));
    taxSummaryTable.addCell(new PdfPCell(new Phrase("Surcharge", new Font(Font.FontFamily.TIMES_ROMAN, 10,
        Font.BOLD))));
    taxSummaryTable.addCell(new PdfPCell(new Phrase("Gross Amount(Amt+Tax+Surcharge)", new Font(Font.FontFamily.TIMES_ROMAN, 10,
        Font.BOLD))));
    ...
    if (enumTaxes.size() > 0) {
      for (EnumTax enumTaxObj : enumTaxes) {
        if (invoiceDto.getSummaryQtyMap().get(enumTaxObj.getName()) != 0l) {
          ...
          taxSummaryTable.addCell(new PdfPCell(new Phrase(enumTaxObj.getName(), new Font(Font.FontFamily.TIMES_ROMAN, 10,
              Font.NORMAL))));
          ...
          taxSummaryTable.addCell(new PdfPCell(new Phrase("" + amount, new Font(Font.FontFamily.TIMES_ROMAN, 10,
              Font.NORMAL))));
          taxSummaryTable.addCell(new PdfPCell(new Phrase("" + taxOnAmt, new Font(Font.FontFamily.TIMES_ROMAN, 10,
              Font.NORMAL))));
          taxSummaryTable.addCell(new PdfPCell(new Phrase("" + surcharge, new Font(Font.FontFamily.TIMES_ROMAN, 10,
              Font.NORMAL))));
          taxSummaryTable.addCell(new PdfPCell(new Phrase("" + grossAmt, new Font(Font.FontFamily.TIMES_ROMAN, 10,
              Font.NORMAL))));
        }
      }
    }
    ...
    taxSummaryTable.addCell(new PdfPCell(new Phrase("Total", new Font(Font.FontFamily.TIMES_ROMAN, 10,
        Font.BOLD))));
    taxSummaryTable.addCell(new PdfPCell(new Phrase("" + invoiceDto.getTotalSummaryQty(), new Font(Font.FontFamily.TIMES_ROMAN, 10,
        Font.NORMAL))));
    taxSummaryTable.addCell(new PdfPCell(new Phrase("" + totalSummaryAmount, new Font(Font.FontFamily.TIMES_ROMAN, 10,
        Font.NORMAL))));
    taxSummaryTable.addCell(new PdfPCell(new Phrase("" + totalSummaryTax, new Font(Font.FontFamily.TIMES_ROMAN, 10,
        Font.NORMAL))));
    taxSummaryTable.addCell(new PdfPCell(new Phrase("" + totalSummarySurcharge, new Font(Font.FontFamily.TIMES_ROMAN, 10,
        Font.NORMAL))));
    taxSummaryTable.addCell(new PdfPCell(new Phrase("" + totalSummaryPayable, new Font(Font.FontFamily.TIMES_ROMAN, 10,
        Font.BOLD))));
  ...
  private void addFooter(Document document, ShippingOrder shippingOrder, B2bUserDetails b2bUserDetails) throws DocumentException {
    ...
    Paragraph authorisedSigntry = new Paragraph(new Phrase("(Authorised Signatory)", new Font(Font.FontFamily.TIMES_ROMAN, 10,
        Font.BOLD)));
    ...
    footerParagraph.add(new Paragraph("Terms & Conditions:", new Font(Font.FontFamily.TIMES_ROMAN, 10,
        Font.BOLD)));
    footerParagraph.add(new Paragraph("1. All disputes are subject to Gurgaon Jurisdiction.", new Font(Font.FontFamily.TIMES_ROMAN, 10,
        Font.NORMAL)));
    if (b2bUserDetails != null) {
      footerParagraph.add(new Paragraph("2. This is computer generated invoice.", new Font(Font.FontFamily.TIMES_ROMAN, 10,
          Font.NORMAL)));
    }
