...
public class PurchaseOrderPDFGenerator {
  ...
  WarehouseService warehouseService;
    ...
    private void createFooter(Document document, PurchaseOrderDto purchaseOrderDto) throws Exception{
        ...
        if(purchaseOrderDto.getPurchaseOrder().getWarehouse().getState().equalsIgnoreCase("MAHARASHTRA")){
        ...
        if(purchaseOrderDto.getPurchaseOrder().getWarehouse().getState().equalsIgnoreCase("HARYANA")){
