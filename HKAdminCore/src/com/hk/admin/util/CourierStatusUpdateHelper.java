...
public class CourierStatusUpdateHelper {
    ...
    public Date updateDeliveryStatusDelhivery(String gatewayOrderId) throws MalformedURLException, IOException {
    ...
    public int updateDeliveryStatusBlueDart(String trackingId) throws MalformedURLException, IOException, JDOMException {
    ...
    public Date updateDeliveryStatusDTDC(Date startDate, Date endDate) throws IOException, JDOMException {
