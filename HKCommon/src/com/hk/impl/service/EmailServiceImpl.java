...
public class EmailServiceImpl implements EmailService {
  ...
  private boolean sendHtmlEmail(Template template, Object templateValues, String fromEmail, String fromName, String toEmail, String toName, String replyToEmail,
    ...
    if (isHybridRelease() || template.getName().equals("orderPlacedCodEmailBeta.ftl") || template.getName().equals("orderShippedEmailNewBeta.ftl") || template.getName().equals("orderPlacedAuthorizedCodEmailBeta.ftl")
        || template.getName().equals("orderPlacedPaymentPendingEmailBeta.ftl") || template.getName().equals("orderShippedEmailNewBeta.ftl") || template.getName().equals("orderCancelEmailUserNewBeta.ftl") ||
        ...
        template.getName().equals("discountCouponEmailBeta.ftl")||template.getName().equals("codConfirmEmailBeta.ftl")) {
