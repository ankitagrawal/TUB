...
public class EmailServiceImpl implements EmailService {
  ...
  */
  ...
  public boolean sendHtmlEmailNoReply(String template, Boolean isTemplateAvailable, Object templateValues, String toEmail, String toName, String subject) {
    return sendHtmlEmail(template, isTemplateAvailable, templateValues, noReplyEmail, noReplyName, toEmail, toName, subject, null, null, null);
  }

  public boolean sendHtmlEmail(String template, Boolean isTemplateAvailable, Object templateValues, String toEmail, String toName, String subject) {
    return sendHtmlEmail(template, isTemplateAvailable, templateValues, noReplyEmail, noReplyName, toEmail, toName, subject, contactEmail, contactName, null);
  }

  public boolean sendHtmlEmail(String template, Boolean isTemplateAvailable, Object templateValues, String toEmail, String toName, String subject, String replyToEmail) {
    return sendHtmlEmail(template, isTemplateAvailable, templateValues, noReplyEmail, noReplyName, toEmail, toName, subject, replyToEmail, null, null);
  }

  public boolean sendHtmlEmail(String template, Boolean isTemplateAvailable, Object templateValues, String toEmail, String toName, String subject, String replyToEmail, Map<String, String> headerMap) {
    return sendHtmlEmail(template, isTemplateAvailable, templateValues, noReplyEmail, noReplyName, toEmail, toName, subject, replyToEmail, null, headerMap);
  }
   ...
   */
  private boolean sendHtmlEmail(String template, Boolean isTemplateAvailable, Object templateValues, String fromEmail, String fromName, String toEmail, String toName, String subject, String replyToEmail,
                                String replyToName, Map<String, String> headerMap) {
    try {
      FreeMarkerService.RenderOutput renderOutput;
      if (isTemplateAvailable) {
        renderOutput = freeMarkerService.getRenderOutputFromString(template, templateValues);
        if (renderOutput == null) {
          logger.error("Error while rendering template from database with subject: " + subject + " in sendHtmlEmail");
          return false;
        }
        renderOutput.setSubject(subject);
      } else {
        renderOutput = freeMarkerService.getRenderOutputForTemplate(template, templateValues);
        if (renderOutput == null) {
          logger.error("Error while rendering freemarker template : " + template + " in sendHtmlEmail");
          return false;
        }
      }
      ...
      if (isTemplateAvailable) {
          logger.error("EmailException in sendHtmlEmail for template with subject: " + subject,e);
      } else {
          logger.error("EmailException in sendHtmlEmail for template " + template, e);
      }
      return false;
    }
    return true;
