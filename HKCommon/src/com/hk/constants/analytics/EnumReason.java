...
public enum EnumReason {
    ...
    REFUND_REPLACEMENT_ORDER(1460L,EnumClassification.REFUND_REPLACEMENT, EnumReasonType.Reconciliation),
    REFUND_REVERSE_PICKUP(1470L,EnumClassification.REFUND_REVERSE_PICK, EnumReasonType.Reconciliation),
    ;
...
//        reason.setClassification(enumClassification.asClassification());
  ...
  public static Set<EnumReason> getAcceptableReasonRefund() {
    Set<EnumReason> acceptableReasons = new HashSet<EnumReason>();
    acceptableReasons.add(EnumReason.REFUND_REPLACEMENT_ORDER);
    acceptableReasons.add(EnumReason.REFUND_REVERSE_PICKUP);
