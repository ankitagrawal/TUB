...
public enum EnumReason {
    ...
    InventoryBookedOnBrightBehalf(250L, "Inventory Booked on  Bright Behalf", EnumReasonType.NotManualEscalated),
    ...
    FITNESSPRO_ORDER_SHIPMENT_NOT_CREATED(1710L,"SO Could not be Auto-escalated", EnumReasonType.ShipmentNotCreatedFromFitnessPro),
    ;
