...
public enum  EnumCourierOperations {
  ...
  PHYSICAL_WT_PREFERRED(23L, "PHYSICAL_WEIGHT_PREFERRED");
  ...
  public  static List<EnumCourierOperations> getAllCourierOperations() {
    return Arrays.asList(HK_SHIPPING, CUSTOMER_RETURNS, COLLECT_FROM_SUPPLIER, DEBIT_NOTE, DISPATCH_LOT,
        VENDOR_DROP_SHIP, REVERSE_PICKUP, PHYSICAL_WT_PREFERRED);
  }
