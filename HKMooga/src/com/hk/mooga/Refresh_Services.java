...
public class Refresh_Services  implements java.io.Serializable {
    private int p_Key;

    private String p_Application;

    public Refresh_Services() {
    }
    ...
    /**
     * Gets the p_Key value for this Refresh_Services.
     * 
     * @return p_Key
     */
    public int getP_Key() {
    ...
    /**
     * Sets the p_Key value for this Refresh_Services.
     * 
     * @param p_Key
     */
    ...
    /**
     * Gets the p_Application value for this Refresh_Services.
     * 
    ...
    /**
     * Sets the p_Application value for this Refresh_Services.
     * 
     * @param p_Application
     */
    ...
    public synchronized boolean equals(Object obj) {
        if (!(obj instanceof Refresh_Services)) return false;
        Refresh_Services other = (Refresh_Services) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(Refresh_Services.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://ikensolution.com/webservices/", ">Refresh_Services"));
