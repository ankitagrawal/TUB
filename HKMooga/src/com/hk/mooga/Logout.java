...
public class Logout  implements java.io.Serializable {
    ...
    /**
     * Gets the p_Key value for this Logout.
     * 
     * @return p_Key
     */
    public int getP_Key() {
    ...
    /**
     * Sets the p_Key value for this Logout.
     * 
     * @param p_Key
     */
    ...
    /**
     * Gets the p_Application value for this Logout.
     * 
    ...
    /**
     * Sets the p_Application value for this Logout.
     * 
     * @param p_Application
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://ikensolution.com/webservices/", ">Logout"));
