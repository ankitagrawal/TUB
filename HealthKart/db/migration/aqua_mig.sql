...
create table sku_item_beta2 as (select * from sku_item);
...
update sku sk join sku_group sg on sg.sku_id=sk.id join sku_item si on si.sku_group_id=sg.id set sku_item_status_id=180 where sk.warehouse_id=401 and si.sku_item_status_id<>20;
update sku sk join sku_group sg on sg.sku_id=sk.id join sku_item si on si.sku_group_id=sg.id set si.barcode=concat('401-MIG-',si.barcode) where sk.warehouse_id=401 and si.sku_item_status_id<>20;
INSERT IGNORE INTO seek_invoice_num (`id`, `warehouse_id`, `invoice_num`, `prefix`, `description`) VALUES (21, '402', '1', 'R', 'Retail Invoice 2013');
INSERT IGNORE INTO seek_invoice_num (`id`, `warehouse_id`, `invoice_num`, `prefix`, `description`) VALUES (22, '402', '1', 'T', 'B2B Invoice 2013');
INSERT IGNORE INTO seek_invoice_num (`id`, `warehouse_id`, `invoice_num`, `prefix`, `description`) VALUES (23, '402', '1', 'DN', 'Debit Note 2013');
...
update sku sk join sku_group sg on sg.sku_id=sk.id join sku_item si on si.sku_group_id=sg.id set sku_item_status_id=180 where sk.warehouse_id=1 and si.sku_item_status_id<>20;
update sku sk join sku_group sg on sg.sku_id=sk.id join sku_item si on si.sku_group_id=sg.id set si.barcode=concat('1-MIG-',si.barcode) where sk.warehouse_id=1  and si.sku_item_status_id<>20;
INSERT IGNORE INTO seek_invoice_num (`id`, `warehouse_id`, `invoice_num`, `prefix`, `description`) VALUES (24, '10', '1', 'R', 'Retail Invoice 2013');
INSERT IGNORE INTO seek_invoice_num (`id`, `warehouse_id`, `invoice_num`, `prefix`, `description`) VALUES (25, '10', '1', 'T', 'B2B Invoice 2013');
INSERT IGNORE INTO seek_invoice_num (`id`, `warehouse_id`, `invoice_num`, `prefix`, `description`) VALUES (26, '10', '1', 'DN', 'Debit Note 2013');
...
update sku sk join sku_group sg on sg.sku_id=sk.id join sku_item si on si.sku_group_id=sg.id set sku_item_status_id=180 where sk.warehouse_id=2 and si.sku_item_status_id<>20;
update sku sk join sku_group sg on sg.sku_id=sk.id join sku_item si on si.sku_group_id=sg.id set si.barcode=concat('2-MIG-',si.barcode) where sk.warehouse_id=2  and si.sku_item_status_id<>20;
INSERT IGNORE INTO seek_invoice_num (`id`, `warehouse_id`, `invoice_num`, `prefix`, `description`) VALUES (27, '20', '1', 'R', 'Retail Invoice 2013');
INSERT IGNORE INTO seek_invoice_num (`id`, `warehouse_id`, `invoice_num`, `prefix`, `description`) VALUES (28, '20', '1', 'T', 'B2B Invoice 2013');
INSERT IGNORE INTO seek_invoice_num (`id`, `warehouse_id`, `invoice_num`, `prefix`, `description`) VALUES (29, '20', '1', 'DN', 'Debit Note 2013');
...
update shipping_order so join base_order bo on so.base_order_id=bo.id set so.shipping_order_status_id=110 where bo.is_b2b_order is NULL and so.shipping_order_status_id in(120,130,140);

update shipping_order so join base_order bo on so.base_order_id=bo.id set so.shipping_order_status_id=1000 , bo.order_status_id=100 where bo.is_b2b_order=1;

update product set supplier_id=383;
