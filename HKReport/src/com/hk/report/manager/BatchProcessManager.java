...
public class BatchProcessManager {
	...
	private static final String dailyCategorySalesReportGenerationCronTime = "0 1 0 ? * *";    //sec || minute || hour || day_of_week || day || month
	...
	//TODO: rewrite
	/*public BatchProcessManager(final SchedulerFactory schedulerFactory)
	                     //,final GuiceJobFactory guiceJobFactory) 
	                     throws SchedulerException {
		log.info("------- Initializing Batch Processer-------------------");
	...
	public void start() {
      ...
      //TODO: uncomment later
			/*JobDetail dailyCategorySalesReportJobDetail = new JobDetail("dailyCategorySalesReportJob", "group1", DailyCategorySalesReportJob.class);*/

//			JobDetail dailyGoogleAdsBannedWordsSearchJobDetail = new JobDetail("googleAdsBannedWordsSearchJob", "group2", DailyGoogleAdsBannedWordsSearchJob.class);


      //JobDetail sixHourlyCategorySalesReportJobDetail = new JobDetail("sixHourlyCategorySalesReportJob", "group5", SixHourlyCategorySalesReportJob.class);


       //TODO: uncomment later
			//CronTrigger dailyCategorySalesReportTrigger = new CronTrigger("emailJobTrigger", "group3", dailyCategorySalesReportGenerationCronTime);
//			CronTrigger dailyGoogleAdsBannedWordsSearchTrigger = new CronTrigger("emailBannedWordsTrigger", "group4", dailyBadWordSearchCronTime);

			//CronTrigger sixHourlyCategorySalesReportTrigger = new CronTrigger("emailJobTrigger", "group6", sixHourlyCategorySalesReportGenerationCronTime);
