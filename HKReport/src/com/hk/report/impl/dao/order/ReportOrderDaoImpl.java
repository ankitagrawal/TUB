...
public class ReportOrderDaoImpl extends BaseDaoImpl implements ReportOrderDao {
    ...
    /*
     * public List<ProductVariant> findOrderedProductVariantsForTimeFrame(Date startDate, Date endDate, OrderStatus
     * orderStatus, Category topLevelCategory) { List<OrderStatus> applicableOrderStatus = new ArrayList<OrderStatus>();
     * if (orderStatus != null) { applicableOrderStatus.add(orderStatus); } else {
    ...
    /*
     * public List<Order> findReconciledOrdersForTimeFrame(Date startDate, Date endDate, OrderStatus orderStatus,
     * PaymentMode paymentMode, Courier codMode, ReconciliationStatus reconciliationStatus) { List<OrderStatus>
     * applicableOrderStatus = new ArrayList<OrderStatus>(); if (orderStatus == null) {
     * applicableOrderStatus.add(orderStatusDao.find(EnumOrderStatus.Shipped.getId()));
     ...
     * lineItemTypeDaoProvider.get().find(EnumLineItemType.Product.getId())) .list(); }
     */

    /*
     * public Long findTotalQtyOfOrderedProductVariantForTimeFrame(ProductVariant productVariant, Date startDate, Date
     * endDate, OrderStatus orderStatus) { List<OrderStatus> applicableOrderStatus = new ArrayList<OrderStatus>(); if
     ...
     * .setParameterList("applicableOrderStatus", applicableOrderStatus) .setParameter("startDate", startDate)
     * .setParameter("endDate", endDate) .uniqueResult(); } public List<DaySaleDto> findBasicCountSaleForTimeFrame(Date
