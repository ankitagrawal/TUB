...
public class UpdatePvPriceDaoImpl extends BaseDaoImpl implements UpdatePvPriceDao {
	...
	public UpdatePvPrice getPVForPriceUpdate(ProductVariant productVariant, Long status) {
		List<UpdatePvPrice> updatePvPriceList = (List<UpdatePvPrice>) findByNamedParams("from UpdatePvPrice upp where upp.productVariant =  :productVariant and upp.status = :status", new String[]{"productVariant", "updated"}, new Object[]{productVariant, status});
