...
public class SkuItemDaoImpl extends BaseDaoImpl implements SkuItemDao {
  ...
  public List<SkuGroup> getInStockSkuGroups(Sku sku) {
	...
	public SkuGroup getMinMRPUnbookedSkuGroup(ProductVariant productVariant, Long bookedQty) {
		...
		String skuItemListQuery = "select pvi.skuItem.id from ProductVariantInventory pvi where pvi.skuItem is not null " + "and pvi.sku.productVariant = :productVariant group by pvi.skuItem.id having sum(pvi.qty) > 0 order by pvi.skuItem.id asc";
