...
public class TekprocessPaymentGatewayWrapper extends BasePaymentGatewayWrapper<TekprocessPaymentGatewayWrapper> implements PaymentGatewayWrapper {
	...
	private static Logger logger = LoggerFactory.getLogger(TekprocessPaymentGatewayWrapper.class);

	public static String merchantCode = "L1340";
...
//    System.out.println("map = "+map);
	...
	public String getGatewayUrl() {
		return "https://www.tpsl-india.in/PaymentGateway/TransactionRequest.jsp";
	}
