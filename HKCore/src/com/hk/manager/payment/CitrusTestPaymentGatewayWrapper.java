...
public class CitrusTestPaymentGatewayWrapper extends BasePaymentGatewayWrapper<CitrusTestPaymentGatewayWrapper> implements PaymentGatewayWrapper {

  private static Logger logger = LoggerFactory.getLogger(CitrusTestPaymentGatewayWrapper.class);
  ...
  public CitrusTestPaymentGatewayWrapper(String environmemtDir) {
