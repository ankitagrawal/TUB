...
/**
 * Created by IntelliJ IDEA. User: Developer Date: Jan 15, 2012 Time: 6:00:34 PM To change this template use File |
...
public class ParseEstimatedCourierExpensesExcelAction extends BaseAction {
    ...
    public Resolution pre() {
        return new ForwardResolution("/pages/admin/parseEstimatedCourierExpensesExcel.jsp");
    }
    ...
    public Resolution parse() throws Exception {
        ...
        String excelFilePath = adminUploadsPath + "/estimatedCourierCollectionCharge/" + uploadTimeInMillis + ".xls";
        ...
        try {
            ...
            messagePostUpdation = xslParser.updateEstimatedCourierCollectionCharges(excelFile);
