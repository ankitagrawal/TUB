...
public class JITManagementQueueAction extends BasePaginatedAction {
    ...
    public Resolution pre() {
        ...
        if (shippingOrderStatus == null) {
            shippingOrderStatus = shippingOrderStatusService.find(EnumShippingOrderStatus.SO_ActionAwaiting);
        }
...
//        ShippingOrderSearchCriteria shippingOrderSearchCriteria = new ShippingOrderSearchCriteria();
//        shippingOrderSearchCriteria.setShippingOrderCategories()
//    }
