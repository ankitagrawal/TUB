...
public class ShippingOrderStatusChangeAction extends BaseAction{
    ...
    public Resolution saveStatus(){
      if(shippingOrder!=null && statusDate !=null &&  statusDate.after(DateUtils.getStartOfThisDay(shippingOrder.getShipment().getShipDate())) && statusDate.before(DateUtils.getEndOfDay(new Date())) ){
