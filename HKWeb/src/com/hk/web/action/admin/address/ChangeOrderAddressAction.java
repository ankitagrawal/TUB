...
public class ChangeOrderAddressAction extends BaseAction {
  ...
  public Resolution save() {
    if (copyToUserAddressBook) {
      newAddress = addressBookManager.editAddress(order.getUser(), order.getAddress(), this.newAddress);  // here edited address is the new address which is to be saved
    } else {
      if(address == null){
