...
public class CatalogAction extends BasePaginatedAction {
	...
	public Resolution pre() throws IOException, SolrServerException {
		...
		try {
			boolean renderNewCatalogUI = Functions.collectionContains(Arrays.asList("eyeglasses","sunglasses","lenses", "proteins", "creatine"), childCategorySlug)
			|| Functions.collectionContains(Arrays.asList("eyeglasses","sunglasses","lenses", "proteins", "creatine"), secondaryChildCategorySlug);
