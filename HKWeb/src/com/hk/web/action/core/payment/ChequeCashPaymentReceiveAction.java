...
public class ChequeCashPaymentReceiveAction extends BaseAction {
    ...
    public Resolution pre() {
        ...
        if (order.getOrderStatus().getId().equals(EnumOrderStatus.InCart.getId())) {
            ...
            Payment payment = getPaymentManager().createNewPayment(order, getPaymentService().findPaymentMode(paymentMode), BaseUtils.getRemoteIpAddrForUser(getContext()), null);
