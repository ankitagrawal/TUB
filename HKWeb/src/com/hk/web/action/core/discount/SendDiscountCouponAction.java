  ...
  public Resolution getDiscountCoupon() {
    ...
    if (StringUtils.isNotBlank(mobile)) {
      ...
      if (discountCouponMailingList != null) {
        // already sent
        return new JsonResolution(new HealthkartResponse(HealthkartResponse.STATUS_OK, "Your discount coupon has already been sent. Please email our customer support on info@healthkart.com if you are not receiving the SMS."));
      } else {
    ...
    if (StringUtils.isNotBlank(email)) {
      ...
      if (discountCouponMailingList != null) {
        // already sent
        return new JsonResolution(new HealthkartResponse(HealthkartResponse.STATUS_OK, "We have resent your discount coupon. If you are not receiving the email, please check your junk email folder. Please email our customer support on info@healthkart.com if you are still not able to get the coupon code."));
      } else {
