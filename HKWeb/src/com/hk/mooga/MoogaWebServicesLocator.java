...
public class MoogaWebServicesLocator extends org.apache.axis.client.Service implements com.hk.mooga.MoogaWebServices {
    ...
    public MoogaWebServicesLocator(java.lang.String wsdlLoc, javax.xml.namespace.QName sName) throws javax.xml.rpc.ServiceException {
        super(wsdlLoc, sName);
    }
    ...
    private java.lang.String MoogaWebServicesSoap12WSDDServiceName = "MoogaWebServicesSoap12";

    public java.lang.String getMoogaWebServicesSoap12WSDDServiceName() {
        return MoogaWebServicesSoap12WSDDServiceName;
    }

    public void setMoogaWebServicesSoap12WSDDServiceName(java.lang.String name) {
    ...
    public com.hk.mooga.MoogaWebServicesSoap_PortType getMoogaWebServicesSoap12(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.hk.mooga.MoogaWebServicesSoap12Stub _stub = new com.hk.mooga.MoogaWebServicesSoap12Stub(portAddress, this);
    ...
    public void setMoogaWebServicesSoap12EndpointAddress(java.lang.String address) {
        MoogaWebServicesSoap12_address = address;
    }


    // Use to get a proxy class for MoogaWebServicesSoap
    private java.lang.String MoogaWebServicesSoap_address = "http://110.234.176.23/HealthKart_Mooga/moogawebservices.asmx";
    ...
    // The WSDD service name defaults to the port name.
    private java.lang.String MoogaWebServicesSoapWSDDServiceName = "MoogaWebServicesSoap";

    public java.lang.String getMoogaWebServicesSoapWSDDServiceName() {
        return MoogaWebServicesSoapWSDDServiceName;
    }

    public void setMoogaWebServicesSoapWSDDServiceName(java.lang.String name) {
    ...
    public com.hk.mooga.MoogaWebServicesSoap_PortType getMoogaWebServicesSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.hk.mooga.MoogaWebServicesSoap_BindingStub _stub = new com.hk.mooga.MoogaWebServicesSoap_BindingStub(portAddress, this);
    ...
    public void setMoogaWebServicesSoapEndpointAddress(java.lang.String address) {
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.hk.mooga.MoogaWebServicesSoap_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                com.hk.mooga.MoogaWebServicesSoap12Stub _stub = new com.hk.mooga.MoogaWebServicesSoap12Stub(new java.net.URL(MoogaWebServicesSoap12_address), this);
                _stub.setPortName(getMoogaWebServicesSoap12WSDDServiceName());
                return _stub;
            }
            if (com.hk.mooga.MoogaWebServicesSoap_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                com.hk.mooga.MoogaWebServicesSoap_BindingStub _stub = new com.hk.mooga.MoogaWebServicesSoap_BindingStub(new java.net.URL(MoogaWebServicesSoap_address), this);
                _stub.setPortName(getMoogaWebServicesSoapWSDDServiceName());
                return _stub;
            }
        }
