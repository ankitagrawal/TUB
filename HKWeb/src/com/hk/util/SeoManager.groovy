...
public class SeoManager {
    ...
    if (seoData.title == null) {
      seoData.title = "${product.name} | Buy Online ${product.name} in India"
    }
    if (seoData.metaKeyword == null) {
      seoData.metaKeyword = "buy ${product.name}, ${product.name} india, buy ${product.name} india, buy ${product.name} online, but ${product.name} online india";
    }
    if (seoData.metaDescription == null) {
      seoData.metaDescription = "Buy ${product.name} Online in India at HealthKart.com. Free home delivery across India on orders above Rs. 250";
    }
    return seoData;
  }
    ...
    if (seoData.title == null) {
      seoData.title = "${name} | Buy Online ${name} in India"
    }
    if (seoData.metaKeyword == null) {
      seoData.metaKeyword = "buy ${name}, ${name} india, buy ${name} india, buy ${name} online, buy ${name} online india";
    }
    if (seoData.metaDescription == null) {
      seoData.metaDescription = "Buy ${name} Online in India at HealthKart.com. Free home delivery across India on orders above Rs. 250";
    }
    return seoData;
  }
    ...
    Product product = getProductService().getProductById(id);
    seoData.id = id
    seoData.h1 = product.name
    seoData.title = "${product.name} | Buy Online ${product.name} in India"
    seoData.metaKeyword = "buy ${product.name}, ${product.name} india, buy ${product.name} india, buy ${product.name} online, but ${product.name} online india";
    seoData.metaDescription = "Buy ${product.name} Online in India at HealthKart.com. Free home delivery across India on orders above Rs. 250";
    seoData.descriptionTitle = "About ${product.name}";
...
// seoData.metaDescription=product.overview;
    ...
    seoData.metaKeyword = "buy ${name}, ${name} india, buy ${name} india, buy ${name} online, buy ${name} online india";
    seoData.metaDescription = "Buy ${name} Online in India at HealthKart.com. Free home delivery across India on orders above Rs. 250";
    seoData.descriptionTitle = "About ${name}";
    ...
    private SeoData generateSeoForBrand(String brandName) {
        SeoData seoData = new SeoData();
        seoData.id = brandName;
        seoData.h1 = brandName;
        seoData.title = brandName;
        seoData.metaKeyword = "buy ${brandName} products, ${brandName} products shop online ";
        seoData.metaDescription = "Buy ${brandName} products online from India's most reliable e-health store. ";
        seoData.descriptionTitle = "About ${brandName}";
    ...
    private SeoData generateSeoForBrandInCategory(String keyForBrandInCat) {
        ...
        brandInCategorySeoData.id = keyForBrandInCat;
        ...
        brandInCategorySeoData.h1 = brandName;
        brandInCategorySeoData.title = brandName;
        brandInCategorySeoData.metaKeyword = brandSeoData.metaKeyword;
        brandInCategorySeoData.metaDescription = brandSeoData.metaDescription;
        brandInCategorySeoData.descriptionTitle = "About ${brandName} ";

        if (brandSeoData.description != null && categorySeoData.description != null) {
            brandInCategorySeoData.description = brandSeoData.description.concat(categorySeoData.description);
        } else if (categorySeoData.description != null) {
            brandInCategorySeoData.description = categorySeoData.description;
        } else if (brandSeoData.description != null) {
            brandInCategorySeoData.description = brandSeoData.description;
        }
