...
<div style="margin-left: auto; margin-right: auto; width:960px;">
  <s:link beanclass="com.hk.web.action.core.user.RequestCallbackAction" id="sendCouponLink">
    <img src="${pageContext.request.contextPath}/images/banners/top/Strip-Banners-Misc-Equipments.jpg" alt="Make the correct choice by knowing the right equipment, ask our experts: request a callback">
  </s:link>
