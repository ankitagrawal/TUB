...
<div style="margin-left: auto; margin-right: auto; width:960px;">
	...
	<%
		...
		if (dateTime.isBefore(endOfBannerDate.getTime())) {
	%>
	<img src="${pageContext.request.contextPath}/images/banners/top/personal-care-strip-banner-dec-20-2012.jpg"
	     alt="10% off on Prepaid Personal Care Orders above Rs. 1000.0">
	<%
		}
	%>
</div>
