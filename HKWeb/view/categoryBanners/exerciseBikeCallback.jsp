...
<div style="margin-left: auto; margin-right: auto; width:960px;">
  <s:link beanclass="com.hk.web.action.core.user.RequestCallbackAction" id="sendCouponLink">
    <img src="${pageContext.request.contextPath}/images/banners/top/Strip-Banners-Exercise-Bikes.jpg" alt="We will help you choose the best exercise bike for you, request a callback">
  </s:link>
