...
<div style="margin-left: auto; margin-right: auto; width:960px;">
  <s:link beanclass="com.hk.web.action.core.user.RequestCallbackAction" id="sendCouponLink">
    <img src="${pageContext.request.contextPath}/images/banners/top/Strip-Banners-Rowing-Machine.jpg" alt="Choose the rowing machine best suited to your workout, request a callback">
  </s:link>
