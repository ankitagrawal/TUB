...
<div style="margin-left: auto; margin-right: auto; width:960px;">
  <s:link beanclass="com.hk.web.action.core.user.RequestCallbackAction" id="sendCouponLink">
    <img src="${pageContext.request.contextPath}/images/banners/top/Strip-Banners-Home-Gym.jpg" alt="Build the right hgym for the perfect workout, ask our experts: request a callback">
  </s:link>
