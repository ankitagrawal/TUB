...
<div style="margin-left: auto; margin-right: auto; width:960px;">
     <img
            src="${pageContext.request.contextPath}/images/banners/health-devices-strip-banner.jpg"
            alt="Flat 25% Off" usemap="#Map">
      <map name="Map" id="Map">
        <area shape="rect" coords="262,-7,453,94" href="${pageContext.request.contextPath}/product/omron-bp-monitor-upper-arm-hem-7112/HB023?camp=7112" />
