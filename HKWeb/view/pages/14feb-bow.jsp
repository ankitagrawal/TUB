...
<div class="cl"></div>
    ...
    <s:layout-render name="/layouts/embed/_productThumb200ny2013.jsp" productId='ALV2' />
    ...
    <s:layout-render name="/layouts/embed/_productThumb200ny2013.jsp" productId='BTQ053' />
    ...
    <s:layout-render name="/layouts/embed/_productThumb200ny2013.jsp" productId='BTY787' />
      ...
      <div class="cl"></div>
		<div class="pages">
			...
			<a class="pages_link" href="${pageContext.request.contextPath}/pages/14feb-bow02.jsp">2</a>
            <a class="pages_link" href="${pageContext.request.contextPath}/pages/14feb-bow03.jsp">3</a>
            <a class="pages_link" href="${pageContext.request.contextPath}/pages/14feb-bow04.jsp">4</a>
            <a class="pages_link" href="${pageContext.request.contextPath}/pages/14feb-bow05.jsp">5</a>
            <a class="pages_link" href="${pageContext.request.contextPath}/pages/14feb-bow06.jsp">6</a>
			<a class="pages_link"  href="${pageContext.request.contextPath}/pages/14feb-bow02.jsp">Next</a>
         </div>
<div class="cl"></div>
