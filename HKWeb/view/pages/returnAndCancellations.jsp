  ...
  <s:layout-component name="rhsContent">
    ...
    <div class="grid_18">
      ...
      <p>
        ...
        0124-4551666 within 14 days of receipt of the product. When we receive the item, we will inspect it to ensure
      ...
      <ul class="niceList">
        ...
        <li>
          To coordinate a return, send a picture of the item(s) to info@healthkart.com with the email title “Return” or call 0124-4551666
      ...
      <p>In case of any queries, please write to our customer care on info@healthkart.com or call us on 0124-4551666</p>
