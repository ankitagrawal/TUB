...
<div class="cl"></div>
    ...
    <s:layout-render name="/layouts/embed/_productThumb200ny2013.jsp" productId='SPT044' />
      ...
      <div class="cl"></div>
		<div class="pages">
            <a class="pages_link"  href="${pageContext.request.contextPath}/pages/14feb-pillow03.jsp">Previous</a>
            ...
            <a class="pages_link" href="${pageContext.request.contextPath}/pages/14feb-pillow07.jsp">7</a>
 			<a class="pages_link"  href="${pageContext.request.contextPath}/pages/14feb-pillow05.jsp">Next</a>
         </div>
<div class="cl"></div>
