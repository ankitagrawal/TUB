...
<div class="cl"></div>
    ...
    <s:layout-render name="/layouts/embed/_productThumb200ny2013.jsp" productId='JLM29' />
      ...
      <div class="cl"></div>
		<div class="pages">
            <a class="pages_link"  href="${pageContext.request.contextPath}/pages/14feb-cologne02.jsp">Previous</a>

			<a class="pages_link" href="${pageContext.request.contextPath}/pages/14feb-cologne.jsp">1</a>
			...
			<a class="pages_link"  href="${pageContext.request.contextPath}/pages/14feb-cologne04.jsp">Next</a>
         </div>
<div class="cl"></div>
