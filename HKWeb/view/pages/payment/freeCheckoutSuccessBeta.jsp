...
<s:layout-render name="/layouts/defaultBeta.jsp" pageTitle="Payment Successful">
  ...
  <s:layout-component name="lhsContent">
    ...
    <c:choose>
      <c:when test="${actionBean.payment != null}">
        <p>Your order has been confirmed. Your order ID is <strong class="txt-blue">${actionBean.payment.order.gatewayOrderId}</strong>.</p>
