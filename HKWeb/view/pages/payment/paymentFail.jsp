...
<s:layout-render name="/layouts/default.jsp" pageTitle="Payment Failed">
  ...
  <s:layout-component name="left_col">
    ...
    <ul type="disc" style="margin-left:20px; list-style:disc;">
            ...
            <li>For any other assistance pertaining to your order contact our customer care at 0124-4551666 or at email:  <a href="mailto:info@healthkart.com">info@healthkart.com</a></li>
          </ul>
