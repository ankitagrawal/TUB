...
<div class="cl"></div>
    ...
    <s:layout-render name="/layouts/embed/_productThumb200ny2013.jsp" productId='SPT066' />
      ...
      <div class="cl"></div>
		<div class="pages">
            <a class="pages_link"  href="${pageContext.request.contextPath}/pages/14feb-dumbells.jsp">Previous</a>
            ...
            <a class="pages_link" href="${pageContext.request.contextPath}/pages/14feb-dumbells07.jsp">7</a>
 			<a class="pages_link"  href="${pageContext.request.contextPath}/pages/14feb-dumbells03.jsp">Next</a>
         </div>
<div class="cl"></div>
