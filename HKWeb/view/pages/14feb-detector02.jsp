...
<div class="cl"></div>
    ...
    <s:layout-render name="/layouts/embed/_productThumb200ny2013.jsp" productId='HB015' />
      ...
      <div class="cl"></div>
		<div class="pages">
            <a class="pages_link"  href="${pageContext.request.contextPath}/pages/14feb-detector.jsp">Previous</a>

			<a class="pages_link" href="${pageContext.request.contextPath}/pages/14feb-detector.jsp">1</a>
            <span class="pages_link">2</span>
            <a class="pages_link" href="${pageContext.request.contextPath}/pages/14feb-detector03.jsp">3</a>
      
			<a class="pages_link"  href="${pageContext.request.contextPath}/pages/14feb-detector03.jsp">Next</a>
         </div>
<div class="cl"></div>
