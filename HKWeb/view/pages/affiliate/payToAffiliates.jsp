...
<s:layout-render name="/layouts/defaultAdmin.jsp">
  <s:layout-component name="content">
    ...
    <s:form beanclass="web.action.affiliate.AffiliatePaymentAction" autocomplete="off">
      ...
      <c:forEach items="${paymentAction.affiliatePaymentDtoList}" var="affiliateDetails" varStatus="ctr">
        <tr>
          ...
          <td>
           ...
           <td>
            <s:link beanclass="web.action.affiliate.AffiliatePaymentAction" event="showAffiliatePlan">Manage Plan
              <s:param name="affiliate" value="${affiliateDetails.affiliate.id}"/>
            </s:link>
          </td>
          <td>
            <s:link beanclass="web.action.affiliate.AffiliatePaymentAction" event="showAffiliateDetails">Transaction Details
              <s:param name="affiliate" value="${affiliateDetails.affiliate.id}"/>
            </s:link>
          </td>
          <td>
