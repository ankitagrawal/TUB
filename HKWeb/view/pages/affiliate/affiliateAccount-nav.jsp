...
<ul style="list-style: none; line-height: 25px;">
  <li><s:link beanclass="com.hk.web.action.ReferralProgramAction" title="Referral Program"> <span id="rpLink">Referral Program</span> </s:link></li>
  <li><s:link beanclass="com.hk.web.action.MyAccountAction" title="My Account"><span id="myAccountLink">My Account</span> </s:link></li>
  <li><s:link beanclass="com.hk.web.action.CustomerOrderHistoryAction" title="Order History"> <span id="ohLink">Order History</span> </s:link></li>
  <shiro:hasRole name="<%=RoleConstants.AFFILIATE%>">
    <li><s:link beanclass="com.hk.web.action.affiliate.AffiliateManageAddressAction" event="manageAddresses" title="My Addresses"><span id="myAddressesLink">My Addresses</span></s:link></li>
  </shiro:hasRole>
