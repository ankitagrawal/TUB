...
<ul style="list-style: none; line-height: 25px;">
  <li><s:link beanclass="com.hk.com.hk.web.action.core.referral.ReferralProgramAction" title="Referral Program"> <span id="rpLink">Referral Program</span> </s:link></li>
  ...
  <li><s:link beanclass="com.hk.com.hk.web.action.core.user.CustomerOrderHistoryAction" title="Order History"> <span id="ohLink">Order History</span> </s:link></li>
  <shiro:hasRole name="<%=RoleConstants.AFFILIATE%>">
    <li><s:link beanclass="com.hk.web.action.core.affiliate.AffiliateManageAddressAction" event="manageAddresses" title="My Addresses"><span id="myAddressesLink">My Addresses</span></s:link></li>
  </shiro:hasRole>
