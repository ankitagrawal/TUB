...
<%--<s:useActionBean beanclass="mhc.web.action.affiliate.AffiliateManageAddressAction" var="affiliateBean" event="showAddressBook"/>--%>
<%--<s:layout-render name="/layouts/default.jsp">--%>
  ...
  <%--<s:layout-component name="rhsContent">--%>
    <%--<div class='left2'>--%>
      <%--<div>--%>
        <%--<s:form beanclass="mhc.web.action.affiliate.AffiliateManageAddressAction">--%>
          ...
          <%--<c:if test="${!empty affiliateBean.addresses}">--%>
            ...
            <%--<c:forEach var="address" items="${affiliateBean.addresses}" varStatus="addressCount">--%>
              <%--<div class="address">--%>
                ...
                <%--<s:link beanclass="mhc.web.action.affiliate.AffiliateManageAddressAction" event="setAsDefaultAddress" class="save" onclick="return confirm('Your cheque will sent here!!')">--%>
                  <%--<s:param name="address" value="${address.id}"/>--%>
                  <%--<s:param name="affiliate" value="${affiliateBean.affiliate.id}"/>--%>
                  <%--(Set as Default)--%>
                <%--</s:link>--%>
                <%--<s:link beanclass="mhc.web.action.affiliate.AffiliateManageAddressAction" event="remove" class="delete" onclick="return confirm('Are you sure you want to delete this address?')">--%>
                  <%--<s:param name="address" value="${address.id}"/>--%>
                  <%--(delete)--%>
                <%--</s:link>--%>
              <%--</div>--%>
          ...
          <%--</c:if>--%>
          <%--<div class='tip'>--%>
            <%--<s:link beanclass="mhc.web.action.affiliate.AffiliateManageAddressAction" event="editUserAddresses">Add New Address</s:link>--%>
          <%--</div>--%>
        <%--</s:form>--%>
      <%--</div>--%>
    <%--</div>--%>
