                ...
                <tr class="variantRow">
                    ...
                    <td>
                        <s:textarea name="options[${ctr.index}]"
                                    value="${productVariant.optionsPipeSeparated}"
                    ...
                    <td>
                            ...
                            <%--<s:text name="productVariants[${ctr.index}].costPrice" style="width:100px;"
                            class="costPrice"/>--%>
                    </td>
                    <td>
                            ${productVariant.markedPrice}
                            <%--<s:text name="productVariants[${ctr.index}].markedPrice" style="width:100px;"
                                    class="markedPrice"/>--%>
                    </td>
                    <td>
                    ...
                    <td>
                        <s:text name="productVariants[${ctr.index}].postpaidAmount" style="width:100px;"
                                class="postpaidAmount"/>
                    </td>
                    <td>
                        <s:text name="productVariants[${ctr.index}].discountPercent" style="width:100px;"
                                class="discountPercent"
                                readonly="readonly"/>
                    </td>
                    <td>
                        <s:text name="productVariants[${ctr.index}].orderRanking" style="width:100px;"
                                class="sorting"/>
                    </td>
                    <td>
                        <s:text name="productVariants[${ctr.index}].freeProductVariant" style="width:100px;"
                                class="freeProductVariant"/>
                    </td>
                    <td>
                        <s:select name="productVariants[${ctr.index}].affiliateCategory"
                                  value="${productVariant.affiliateCategory.affiliateCategoryName}"
                                  class="affiliateCategory" style="width:100px;">
                            <s:option value="">None</s:option>
                            <hk:master-data-collection service="<%=MasterDataDao.class%>"
                                                       serviceProperty="allAffiliateCategories"
                    ...
                    <td><s:link beanclass="com.hk.web.action.admin.inventory.ListBatchesAndCheckinInventory"
                                target="_blank">
                        <s:param name="upc"
                                 value="${productVariant.id}"/>${hk:netInventoryAtServiceableWarehouses(productVariant)}
                    </s:link>
                    </td>
                    <td>
                    ...
                    <td>
                        <s:select name="productVariants[${ctr.index}].estimatedBoxSize"
                                  value="${productVariant.estimatedBoxSize.name}"
                                  class="estimatedBoxSize" style="width:100px;">
                            <hk:master-data-collection service="<%=MasterDataDao.class%>" serviceProperty="boxSizes"
                                                       label="name" value="id"/>
                        </s:select><br/>
                    </td>
                    <td>
                        <s:text name="productVariants[${ctr.index}].commission" style="width:50px;"/>
                    </td>
                    <td>
                    ...
                    <td>
                        <s:textarea name="extraOptions[${ctr.index}]"
                                    value="${productVariant.extraOptionsPipeSeparated}"
                                    style="width:auto; height:auto;"/>
                    </td>
                    ...
                    <td><s:text name="productVariants[${ctr.index}].nextAvailableDate" class="date_input"
                                formatPattern="yyyy-MM-dd" style="width:100px;"/></td>
                    <td><s:text name="productVariants[${ctr.index}].followingAvailableDate" class="date_input"
                                formatPattern="yyyy-MM-dd" style="width:100px;"/></td>
                    <td><s:text name="productVariants[${ctr.index}].supplierCode" style="width:50px;"/></td>
                    <td><s:textarea name="productVariants[${ctr.index}].otherRemark"
