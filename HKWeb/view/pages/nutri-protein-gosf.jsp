...
<s:layout-component name="content">
    ...
    <div id="pageContainer">
        ...
        <s:layout-render name="/layouts/embed/_productThumb200gosf.jsp" productId='NUT1368'productDesc='copy due'/>
        ...
        <s:layout-render name="/layouts/embed/_productThumb200gosf.jsp" productId='NUT1367' productDesc='Tailored for fitness enthusiasts engaged in heavy workouts, it has 25gm of 100% Whey Protein blend and EAAs per serving.'/>
        <s:layout-render name="/layouts/embed/_productThumb200gosf.jsp" productId='NUT1367' productDesc='Tailored for fitness enthusiasts engaged in heavy workouts, it has 25gm of 100% Whey Protein blend and EAAs per serving.'/>
        <s:layout-render name="/layouts/embed/_productThumb200gosf.jsp" productId='NUT1367' productDesc='Built for fitness enthusiasts engaged in heavy workouts, this supplement provides 25gm of 100% Whey Protein blend and EAAs'/>
        <s:layout-render name="/layouts/embed/_productThumb200gosf.jsp" productId='NUT1367' productDesc='Tailored for fitness enthusiasts engaged in heavy workouts, it has 25gm of 100% Whey Protein blend and EAAs per serving.'/>
        ...
        <s:layout-render name="/layouts/embed/_productThumb200gosf.jsp" productId='NUT891' productDesc='If you are exhausted at the end of every work out, MusclePharm Recon is the post workout supplement you need. '/>
        <s:layout-render name="/layouts/embed/_productThumb200gosf.jsp" productId='NUT891'productDesc='copy due'/>
        ...
        <s:layout-render name="/layouts/embed/_productThumb200gosf.jsp" productId='NUT131' productDesc='A fat-free, carb-free, protein supplement. Gain muscles faster'/>
        <s:layout-render name="/layouts/embed/_productThumb200gosf.jsp" productId='NUT131'productDesc='copy due'/>
        <s:layout-render name="/layouts/embed/_productThumb200gosf.jsp" productId='NUT131' productDesc='Fat-free, carb-free, protein supplement. Gain muscle and have better stores of energy'/>
        ...
        <s:layout-render name="/layouts/embed/_productThumb200gosf.jsp" productId='NUT1340' productDesc='If you are a fitness enthusiast, Delicious Whey protein powder should be your first choice to build and maintain muscle mass'/>
        <s:layout-render name="/layouts/embed/_productThumb200gosf.jsp" productId='NUT1340' productDesc='A weight loss supplement and a rich source of protien.'/>
        <s:layout-render name="/layouts/embed/_productThumb200gosf.jsp" productId='NUT1340' productDesc='A weight loss supplement and a rich source of protien.'/>
        ...
        <s:layout-render name="/layouts/embed/_productThumb200gosf.jsp" productId='NUT1332' productDesc='A calorie weight ganiner that increases muscle mass and strength.'/>
        <s:layout-render name="/layouts/embed/_productThumb200gosf.jsp" productId='NUT1332' productDesc='A calorie weight ganiner that increases muscle mass and strength.'/>
        <s:layout-render name="/layouts/embed/_productThumb200gosf.jsp" productId='NUT1332'productDesc='copy due'/>
        ...
        <s:layout-render name="/layouts/embed/_productThumb200gosf.jsp" productId='NUT1339'productDesc='copy due'/>
        <s:layout-render name="/layouts/embed/_productThumb200gosf.jsp" productId='NUT1339'productDesc='copy due'/>
        ...
        <s:layout-render name="/layouts/embed/_productThumb200gosf.jsp" productId='NUT681' productDesc='An effective weight gain supplement with 100%IsoChill Whey Isolate, a balanced whey protein form.'/>
        <s:layout-render name="/layouts/embed/_productThumb200gosf.jsp" productId='NUT681' productDesc='An effective weight gain supplement with 100%IsoChill Whey Isolate, a balanced whey protein form.'/>
        <s:layout-render name="/layouts/embed/_productThumb200gosf.jsp" productId='NUT681' productDesc='Heavy lifting and strenuous workouts are easier if you are chilling with ISOChill. Boost your immunity & recovery in one go!'/>
        <s:layout-render name="/layouts/embed/_productThumb200gosf.jsp" productId='NUT681' productDesc='Augmented with Colostrum, it improves the immune function and offers free GLT to the body'/>
        ...
        <s:layout-render name="/layouts/embed/_productThumb200gosf.jsp" productId='NUT680' productDesc='Fortified with high quality Whey protein. The perfect complement for the serious body builder'/>
        <s:layout-render name="/layouts/embed/_productThumb200gosf.jsp" productId='NUT680' productDesc='Maintain toned muscles and over all built. A free Muscle Blaze DVD included with instructions for a better workout'/>
        ...
        <s:layout-render name="/layouts/embed/_productThumb200gosf.jsp" productId='NUT1162'productDesc='copy due'/>
