    ...
    <s:layout-component name="rhsContent">
        ...
        <div class="mrgn-l-40 my-acnt-ht">
            <table class="cont footer_color" style="font-size: 14px;" id="summary">
                <tr>
                    <td class="pad5">Redeemable Points:</td>
                    <td class="pad5 cont-rht">
                        <fmt:formatNumber value="${rpBean.redeemablePoint}"
                                          pattern="<%=FormatUtils.currencyFormatPattern%>"/>
                    </td>
                </tr>
                <tr>
                    <td class="pad5">Overused Reward Points:</td>
                    <td class="pad5 cont-rht">
                ...
                <tr>
                    <td class="pad5"><span
                            class="fnt-bold lightBlue">Balance Reward Points:</span></td>
                    <td class="pad5 cont-rht">
          <span class="fnt-bold lightBlue">
          <fmt:formatNumber
