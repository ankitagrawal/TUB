...
<div class="cl"></div>
    ...
    <s:layout-render name="/layouts/embed/_productThumb200ny2013.jsp" productId='SPT179' />
      ...
      <div class="cl"></div>
		<div class="pages">
            <a class="pages_link"  href="${pageContext.request.contextPath}/pages/14feb-tennis05.jsp">Previous</a>
			...
			<a class="pages_link"  href="${pageContext.request.contextPath}/pages/14feb-tennis07.jsp">Next</a>
         </div>
<div class="cl"></div>
