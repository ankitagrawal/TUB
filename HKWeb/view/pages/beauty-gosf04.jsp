    ...
    <div id="pageContainer">
        ...
        <div class="cl"></div>
         ...
         <div class="prodBoxes">
			...
			<s:layout-render name="/layouts/embed/_productThumb200gosf.jsp" productId='H2O06' productDesc='Gentle cleanser with Marine Botanicals and Sea Mineral Complex, cleans the skin and moisturizes with Provitamin B,.'/>
