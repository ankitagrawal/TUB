...
<head>
  ...
  <s:useActionBean beanclass="web.action.AccountingInvoiceAction" event="serviceInvoice" var="orderSummary"/>
...
<table>
  <td>
    <b>Invoice#&nbsp;</b>S-${orderSummary.accountingInvoice.serviceInvoiceId}&nbsp; on
