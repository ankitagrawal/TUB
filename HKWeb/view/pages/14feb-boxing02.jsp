...
<div class="cl"></div>
    ...
    <s:layout-render name="/layouts/embed/_productThumb200ny2013.jsp" productId='ZUSKA022' />
      ...
      <div class="cl"></div>
		<div class="pages">
            <a class="pages_link"  href="${pageContext.request.contextPath}/pages/14feb-boxing.jsp">Previous</a>
			...
			<a class="pages_link"  href="${pageContext.request.contextPath}/pages/14feb-boxing03.jsp">Next</a>
         </div>
<div class="cl"></div>
