...
<s:layout-render name="/layouts/fbDefault.jsp">
    ...
    <script type="text/javascript">
      ...
      function publish() {
        FB.ui({
          ...
          message: 'I got a 8"x10" collage absolutely free from HealthKart. Wow!! Get yours too before the offer ends.',
          attachment: {
            name: 'Claim your\'s now. Limited Period Offer.',
            caption: '',
            description: (
            ...
            href: 'http://www.facebook.com/healthkart?v=app_141157445956774',
            media: [{
              type: "image",
              src: 'http://simg.healthkart.com/common/images/fb/Favicon-8x10Free.jpg',
              href: 'http://www.facebook.com/healthkart?v=app_141157445956774'
            }]
          },
  ...
  <s:layout-component name="content">
    ...
    <div class="shareContainer">
      <a class="shareLink" href="#"><img src="${pageContext.request.contextPath}/common/images/fb/FanDeal-2.jpg"/></a>.
    </div>
    <div style="display:none;" class="couponContainer">
        <img src="${pageContext.request.contextPath}/common/images/fb/FanDeal-HMIT5-8x10.jpg"/>
        <a href="http://www.healthkart.com/Doodlepad.action?productId=11040#" target="_blank"><img src="${pageContext.request.contextPath}/common/images/fb/FanDeal-4.jpg"/></a>
    </div>
    <%
      }else{
    %>
