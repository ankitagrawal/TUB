...
<b class="question">1. How do you ship your orders?</b><br>
<p style="text-align: justify">
  ...
  <b class="question">2. Do you ship to international locations?</b><br>
  <p style="text-align: justify">
    We currently ship only within India and do not ship to any international location.
  </p>

  <b class="question">3. How much time does it take for an order to be delivered?</b><br>
  <p style="text-align: justify">
  ...
  <b class="question">4. How can I track my order?</b><br>
  <p style="text-align: justify">
    As soon as we ship your order, you receive an e-mail notification with a link to track your order. You can also
    access this information from your ‘My Account’ section at the top right corner on our website
  ...
  <b class="question">5. How long do you take to dispatch an order?</b><br>
  <p style="text-align: justify">
    The duration of dispatching an order depends on the type of order you have placed. Types of order are:
    <br>In-stock items (Items that we stock in our 4 warehouses across India: Gurgaon, Mumbai,
    Bangalore and Delhi): These items are dispatched the same or the next day of order placement.
    <br>JIT Items (Just-in-time Items): These items are procured from vendors on receiving your confirmation on an order.
  ...
  <b class="question">6. What are the shipping charges on healthkart.com?</b><br>
  <p style="text-align: justify">
    ...
    <b>Note:</b> Certain additional procedures like state-wise taxes may apply to your order depending upon you order type,
