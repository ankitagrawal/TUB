...
<div class="cl"></div>
    ...
    <s:layout-render name="/layouts/embed/_productThumb200ny2013.jsp" productId='BAB2236' />
    ...
    <s:layout-render name="/layouts/embed/_productThumb200ny2013.jsp" productId='CMB-BAB0383' />
    ...
    <s:layout-render name="/layouts/embed/_productThumb200ny2013.jsp" productId='BAB1259' />
      ...
      <div class="cl"></div>
		<div class="pages">
            <a class="pages_link"  href="${pageContext.request.contextPath}/pages/14feb-diaper.jsp">Previous</a>
			...
			<a class="pages_link"  href="${pageContext.request.contextPath}/pages/14feb-diaper03.jsp">Next</a>
         </div>
<div class="cl"></div>
