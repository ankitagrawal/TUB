...
<s:layout-definition>
  ...
  %>
  <div class="pagi embedMarginTop20">
    <div class="links">
      ...
      %>
      <s:layout-render name="/pages/loyalty/_pageNoLink.jsp" paginatedBean="${paginatedBean}" pageNo="<%=pageNo%>" pageText="<%=pageNo%>"/>
      <%
        }
      %>

      <s:layout-render name="/pages/loyalty/_pageNoLink.jsp" paginatedBean="${paginatedBean}" pageNo="<%=basePaginatedAction.getPageCount()-1%>" pageText="<%=basePaginatedAction.getPageCount()-1%>"/>
      <s:layout-render name="/pages/loyalty/_pageNoLink.jsp" paginatedBean="${paginatedBean}" pageNo="<%=basePaginatedAction.getPageCount()%>" pageText="<%=basePaginatedAction.getPageCount()%>"/>
      <%
      } else if ((basePaginatedAction.getPageCount() - basePaginatedAction.getPageNo()) < (maxDisplay - 4)) {
        // Case 2
      %>
      <s:layout-render name="/pages/loyalty/_pageNoLink.jsp" paginatedBean="${paginatedBean}" pageNo="1" pageText="1"/>
      <s:layout-render name="/pages/loyalty/_pageNoLink.jsp" paginatedBean="${paginatedBean}" pageNo="2" pageText="2"/>
