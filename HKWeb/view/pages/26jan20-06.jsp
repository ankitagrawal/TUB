...
<!--container01 close-->
    ...
    <div class="cl"></div>
         <div class="pages">
             <a class="next"  href="${pageContext.request.contextPath}/pages/26jan20-05.jsp">← Previous</a>
             ...
             <a class="next"  href="${pageContext.request.contextPath}/pages/26jan20-07.jsp">Next →</a>
          </div>
 <div class="cl"></div>
