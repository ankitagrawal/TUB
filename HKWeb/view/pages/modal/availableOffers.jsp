...
<s:useActionBean beanclass="web.action.AvailabeOfferListAction" event="pre" var="offerBean"/>
  ...
  <s:layout-component name="content">
    ...
    <c:choose>
      <c:when test="${fn:length(offerBean.offerInstanceList) > 0}">
        <s:form beanclass="web.action.AvailabeOfferListAction" method="post" id="offerForm">
