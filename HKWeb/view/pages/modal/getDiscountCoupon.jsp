...
<s:useActionBean beanclass="web.action.SendDiscountCouponAction" var="sdcActionBean" event="pre"/>
<s:layout-render name="/layouts/modal.jsp">
  ...
  <s:layout-component name="content">
    <div class='left'>
      ...
      <div class='signup'>
        <s:form beanclass="web.action.SendDiscountCouponAction" id="sendCouponForm">
