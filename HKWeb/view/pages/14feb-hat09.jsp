...
<div class="cl"></div>
    ...
    <s:layout-render name="/layouts/embed/_productThumb200ny2013.jsp" productId='KENT17' />
      ...
      <div class="cl"></div>
		<div class="pages">
            <a class="pages_link"  href="${pageContext.request.contextPath}/pages/14feb-hat08.jsp">Previous</a>
			...
			<a class="pages_link"  href="${pageContext.request.contextPath}/pages/14feb-hat10.jsp">Next</a>
         </div>
<div class="cl"></div>
