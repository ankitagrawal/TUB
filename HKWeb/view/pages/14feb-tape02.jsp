...
<div class="cl"></div>
    ...
    <s:layout-render name="/layouts/embed/_productThumb200ny2013.jsp" productId='NUT982' />
        ...
        <div class="cl"></div>
		<div class="pages">
	        <a class="pages_link"  href="${pageContext.request.contextPath}/pages/14feb-tape.jsp">Previous</a>
			<a class="pages_link" href="${pageContext.request.contextPath}/pages/14feb-tape.jsp">1</a>
