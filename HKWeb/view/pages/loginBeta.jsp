          ...
          <s:form beanclass="com.hk.web.action.core.auth.LoginAction" name="signin">
            ...
            <fieldset class="mrgn-b-20">
              ...
              <label class="radio mrgn-b-5">
                <input type="radio"  id="typeNew"  name="type" class="auto-adjust check-empty" value="new"/> I am a new
                user
              </label>

              <label class="radio">
                <input type="radio" name="type" id="typeExist" class="auto-adjust check-empty" value="old"
