...
<div class="cl"></div>
   ...
   <s:layout-render name="/layouts/embed/_productThumb200ny2013.jsp" productId='BTY436' />
    ...
    <s:layout-render name="/layouts/embed/_productThumb200ny2013.jsp" productId='FAC126' />
      ...
      <div class="cl"></div>
		<div class="pages">
            <a class="pages_link"  href="${pageContext.request.contextPath}/pages/campaign/valentines-day/14feb-foot04.jsp">Previous</a>
			...
			<a class="pages_link"  href="${pageContext.request.contextPath}/pages/campaign/valentines-day/14feb-foot06.jsp">Next</a>
         </div>
<div class="cl"></div>
