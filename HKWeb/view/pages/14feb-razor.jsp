...
<div class="cl"></div>
    ...
    <s:layout-render name="/layouts/embed/_productThumb200ny2013.jsp" productId='PHILI06' />
		...
		<div class="pages">
			...
			<a class="pages_link" href="${pageContext.request.contextPath}/pages/14feb-razor02.jsp">2</a>
			<a class="pages_link"  href="${pageContext.request.contextPath}/pages/14feb-razor02.jsp">Next</a>
         </div>
