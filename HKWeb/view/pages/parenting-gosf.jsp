    ...
    <div id="pageContainer">
       ...
       <jsp:include page="../includes/_menuGosf.jsp"/>
        ...
        <div class="prodBoxes">        
			...
			<s:layout-render name="/layouts/embed/_productThumb200gosf.jsp" productId='BAB459-01' productDesc='Ensure your babys health with the Nuby Microwave Steam Sterilizer by keeping his food and water germ free'/>
			...
			<s:layout-render name="/layouts/embed/_productThumb200gosf.jsp" productId='BAB1992-01' productDesc='Stroll your little one in this buggy inspired Sunbaby Stroller, having cushioned seat and a hood protecting him from sun.'/>
			<s:layout-render name="/layouts/embed/_productThumb200gosf.jsp" productId='BAB2087-01' productDesc='Let your child move with care and comfort in this stylish and versatile Chicco Juvenile Stroller.'/>
			<s:layout-render name="/layouts/embed/_productThumb200gosf.jsp" productId='BAB2147-01' productDesc='Calm down your crying baby with this musical toy having soft and soothing lights, and which activates to the sound of cry. '/>
			<s:layout-render name="/layouts/embed/_productThumb200gosf.jsp" productId='BAB2158-01' productDesc='Help your baby sleep in the melodious music and soothing lights of Chicco Sweetheart Bear.'/>
       	</div>
