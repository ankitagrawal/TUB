...
<s:layout-component name="modal">
  ...
  <c:if test="${!empty pa.product.productVariants[0].productExtraOptions}">
    <s:layout-render name="/pages/modal/productWithExtraOptions.jsp" product="${pa.product}" productReferrerId="${pa.productReferrerId}"/>
...
<s:layout-component name="product_variants">
  <c:choose>
          ...
          <c:choose>
            <c:when test="${!pa.product.productHaveColorOptions}">
              <s:layout-render name="/layouts/embed/_productWithMultipleVariantsWithNoColorOptions.jsp"
                               product="${pa.product}" productReferrerId="${pa.productReferrerId}"/>
        ...
        <c:otherwise>
          <c:choose>
            ...
            <c:when test="${hk:collectionContains(pa.product.categories, eyeGlass)}">
              ...
              <s:layout-render name="/layouts/embed/glasses.jsp" product="${pa.product}" productReferrerId="${pa.productReferrerId}"/>
            </c:when>
            <c:otherwise>
              <s:layout-render name="/layouts/embed/_productWithSingleVariant.jsp" product="${pa.product}" productReferrerId="${pa.productReferrerId}"/>
            </c:otherwise>
          </c:choose>
        </c:otherwise>
      </c:choose>
    ...
    <c:otherwise>
      <s:layout-render name="/layouts/embed/_productWithExtraOptions.jsp" product="${pa.product}" productReferrerId="${pa.productReferrerId}"/>
