...
<s:layout-component name="content">
    ...
    <div id="pageContainer">
        ...
        <div class="heading1">PROTEINS & MASS GAINERS</div>
            ...
            <a class="next"  href="${pageContext.request.contextPath}/pages/nutri-protein-gosf02.jsp">← Previous</a>
            ...
            <a class="next"  href="${pageContext.request.contextPath}/pages/nutri-protein-gosf04.jsp">Next →</a>
