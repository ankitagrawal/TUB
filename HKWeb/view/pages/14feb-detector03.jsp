...
<div class="cl"></div>
    ...
    <s:layout-render name="/layouts/embed/_productThumb200ny2013.jsp" productId='ZEPT002' />  
      ...
      <div class="cl"></div>
		<div class="pages">
            <a class="pages_link"  href="${pageContext.request.contextPath}/pages/14feb-detector02.jsp">Previous</a>

			<a class="pages_link" href="${pageContext.request.contextPath}/pages/14feb-detector.jsp">1</a>

            <a class="pages_link" href="${pageContext.request.contextPath}/pages/14feb-detector02.jsp">2</a>
