...
<%
	int sNo = 0;
	List<FAQ> faqList = (new FAQAction()).getFAQs("", Level1Category.Eye.toString());
...
<p><a target="_parent" style="color:gray; font-family: Arial,Helvetica,sans-serif; font-size: 13px" 
	href="${pageContext.request.contextPath}/pages/aboutContactLens.jsp#qId<%=faq.getId() %>"><%=faq.getQuestion()%></a></p> 
<%
	}
%>
</div>
