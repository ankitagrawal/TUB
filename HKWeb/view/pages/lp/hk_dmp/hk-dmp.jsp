...
<div class="cl"></div>
<span style="margin-left:18px;">Valid till December 31, 2012</span>
<h2 class="dbm" style="margin-top:15px;">Special Offers for Abbott Employees<span><a
        href="${pageContext.request.contextPath}/home-devices/blood-pressure/bp-monitor?brand=Omron"></a></span></h2>

<div class="productThumb">
    <p class="tThumb">
        <a href="${pageContext.request.contextPath}/product/freestyle-optium-glucometer/DM033"><img src="${pageContext.request.contextPath}/pages/lp/hk_dmp/images/DM033.jpg" width="208" height="170"/></a></p>
...
<div class="productThumb">
    <p class="tThumb">
       <a href="${pageContext.request.contextPath}/product/freestyle-optium-strips/DS038"> <img src="${pageContext.request.contextPath}/pages/lp/hk_dmp/images/DS038.jpg" width="201" height="170"/></a></p>
...
<div class="cl"></div>
<span style="margin-left:18px;">Valid till December 31, 2012</span>
<h2 class="dbm" style="margin-top:15px;">Omron BP Monitor<span><a
        href="${pageContext.request.contextPath}/home-devices/blood-pressure/bp-monitor?brand=Omron">See More</a></span>
</h2>

<div class="productThumb">
    <p class="tThumb">
        <a href="${pageContext.request.contextPath}/product/omron-bp-monitor-upper-arm-hem-7111/HB004"><img src="${pageContext.request.contextPath}/pages/lp/hk_dmp/images/hem-7111.jpg" width="218" height="170"/></a></p>
...
<div class="productThumb">
    <p class="tThumb">
        <a href="${pageContext.request.contextPath}/product/omron-bp-monitor-upper-arm-hem-7203/HB005"><img src="${pageContext.request.contextPath}/pages/lp/hk_dmp/images/hem-7203.jpg" width="221" height="170"/></a></p>
...
<div class="productThumb">
    <p class="tThumb">
       <a href="${pageContext.request.contextPath}/product/omron-bp-monitor-upper-arm-hem-7101/HB041"> <img src="${pageContext.request.contextPath}/pages/lp/hk_dmp/images/hem-7101.jpg" width="227" height="170"/></a></p>
...
<div class="productThumb">
    <p class="tThumb">
       <a href="${pageContext.request.contextPath}/product/splenda-tablets/NUT103"> <img src="${pageContext.request.contextPath}/pages/lp/hk_dmp/images/nut-103.jpg" width="170" height="170"/></a></p>
...
<div class="productThumb">
    <p class="tThumb">
       <a href="${pageContext.request.contextPath}/product/splenda-granulated/SWT001"> <img src="${pageContext.request.contextPath}/pages/lp/hk_dmp/images/swt-001.jpg" width="170" height="170"/></a></p>
...
<div class="productThumb">
    <p class="tThumb">
       <a href="${pageContext.request.contextPath}/product/splenda-packets/SWT002"> <img src="${pageContext.request.contextPath}/pages/lp/hk_dmp/images/swt-002.jpg" width="170" height="170"/></a></p>
...
<div class="productThumb">
    <p class="tThumb">
        <a href="${pageContext.request.contextPath}/product/vitamin-shoppe-advanced-sugar-support/NUT1107"><img src="${pageContext.request.contextPath}/pages/lp/hk_dmp/images/nut-1107.jpg" width="121" height="170"/></a></p>
...
<div class="productThumb">
    <p class="tThumb">
        <a href="${pageContext.request.contextPath}/product/vitamin-shoppe-fenugreek-extract/NUT1079"><img src="${pageContext.request.contextPath}/pages/lp/hk_dmp/images/nut-1079.jpg" width="170" height="170"/></a></p>
...
<div class="productThumb">
    <p class="tThumb">
        <a href="${pageContext.request.contextPath}/product/glucerna-sr/NUT689"><img src="${pageContext.request.contextPath}/pages/lp/hk_dmp/images/nut-689.jpg" width="198" height="170"/></a></p>
...
<div class="productThumb">
    <p class="tThumb">
        <a href="${pageContext.request.contextPath}/product/dana-diabetic-jam-danish/NUT109"><img src="${pageContext.request.contextPath}/pages/lp/hk_dmp/images/nut-109.jpg" width="169" height="170"/></a></p>
...
<div class="productThumb">
    <p class="tThumb">
       <a href="${pageContext.request.contextPath}/product/sugarless-bliss-sugar-free-cookies/NUT107"> <img src="${pageContext.request.contextPath}/pages/lp/hk_dmp/images/nut-107.jpg" width="170" height="170"/></a></p>
...
<div class="productThumb">
    <p class="tThumb">
       <a href="${pageContext.request.contextPath}/product/golightly-sugarfree-chocolate-mint-candy/SWT005"> <img src="${pageContext.request.contextPath}/pages/lp/hk_dmp/images/swt-005.jpg" width="170" height="170"/></a></p>
...
<div class="productThumb">
    <p class="tThumb">
       <a href="${pageContext.request.contextPath}/product/tynor-full-silicon-insole-k01/FCDIA006"><img src="${pageContext.request.contextPath}/pages/lp/hk_dmp/images/FCDIA006.jpg" width="113" height="170"/></a></p>
...
<div class="productThumb">
    <p class="tThumb">
       <a href="${pageContext.request.contextPath}/product/amron-feather-diabetic-socks/DIASOC001"> <img src="${pageContext.request.contextPath}/pages/lp/hk_dmp/images/DIASOC001.jpg" width="171" height="170"/></a>
    </p>
...
<div class="productThumb">
    <p class="tThumb">
       <a href="${pageContext.request.contextPath}/product/zori-orthotic-slippers-unisex-red-white/FC044"> <img src="${pageContext.request.contextPath}/pages/lp/hk_dmp/images/FC044.jpg" width="170" height="170"/></a></p>
