    ...
    <div class="main-container">
        ...
        <div class="container">
            ...
            <div class="txt-container border">
                <h2>Ornithine Alpha-Ketoglutarate</h2>
                <p>A combination of amino acids-ornithine and glutamine. OKG is proven to improve protein retention,
                    wound repair and immune function partly by increasing levels of growth-promoting (anabolic) hormones such as insulin and growth hormone.</p>
            </div>
            ...
            <div class="txt-container">
                <h2>Overtraining</h2>
                <p>A state of being where an individual trains too much with extreme intensity and without sufficient nutrition and sleep.
                    The old saying goes that there is no such thing as overtraining, only under eating and under sleeping.</p>
            </div>
