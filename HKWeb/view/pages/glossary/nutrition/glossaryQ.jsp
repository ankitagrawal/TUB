    ...
    <div class="main-container">
        ...
        <div class="container">
            ...
            <div class="txt-container">
                <h2>Quercetin</h2>
                <p>A flavonoid and antioxidant that forms the "backbone" for many other flavonoids, including the citrus flavonoids rutin, hesperidin, naringen and tangeritin.
                    Quercetin is found to be the most active of the flavonoids in studies. It has demonstrated significant anti-inflammatory activity because of direct inhibition of
                    several initial processes of inflammation.</p>
            </div>
