    ...
    <div class="main-container">
        ...
        <div class="container">
            ...
            <div class="txt-container">
                <h2>K-R-Alpha Lipoic Acid (K-R-ALA)</h2>
                <p>A form of Alpha-Lipoic Acid (ALA),it is one of the most potent free radical scavengers.
                    K-R-ALA is aimed at improving insulin response and sensitivity.
                    The R form of ALA has been shown to increase ATP production which results in strength gain in human muscle tissue and an increase in energy.
                    Adding Potassium (K) to the R-ALA helps to keep the molecule extremely stable.</p>
            </div>
