...
<s:useActionBean beanclass="web.action.SelectAddressAction" event="pre" var="addressBean"/>
<s:useActionBean beanclass="web.action.CartAction" var="cartAction" event="pre"/>
  ...
  <div class='current_step_content'>
    ...
    <div class='left2'>
      ...
      <c:forEach items="${addressBean.addresses}" var="address" varStatus="addressCount">
        <s:link beanclass="web.action.SelectAddressAction" event="checkout" title="Click to use this address and proceed">
          ...
          <div class="address" style="position: relative;">
            ...
            <br/>
            <s:link beanclass="web.action.SelectAddressAction" event="remove" class="delete" onclick="return confirm('Are you sure you want to delete this address?')">
    ...
    <div class='right'>
      ...
      <div class="addressContainer shipping_address">
        ...
        <s:form beanclass="web.action.NewAddressAction" id="newAddressForm">
