    ...
    <s:layout-render name="/layouts/embed/_productThumb200ny2013.jsp" productId='BTY456' />
     ...
     <div class="cl"></div>
		<div class="pages">
			...
			<a class="pages_link" href="${pageContext.request.contextPath}/pages/14feb-suspects-02.jsp">2</a>
			<a class="pages_link"  href="${pageContext.request.contextPath}/pages/14feb-suspects-02.jsp">Next</a>
         </div>
