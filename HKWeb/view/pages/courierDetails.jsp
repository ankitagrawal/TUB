...
<s:layout-render name="/layouts/default.jsp" pageTitle="Courier Services">
  <s:layout-component name="heading">Order Shipped through <%=request.getAttribute("courierName")%> Courier Services</s:layout-component>
  <s:layout-component name="rhsContent">
    <c:choose>
      <c:when test="${tca.status== null}">
        ...
        <div>
          Sorry, there is no return of Information from <%=request.getAttribute("courierName")%> Courier Services
          <br/>
          please
