    ...
    <div>
      <s:form beanclass="com.hk.web.action.core.user.UserManageAddressAction">
        ...
        <div class="row">
          ...
          <s:text name="address.name" value="${address.name}" class="rowText"/>
        </div>
        ...
        <div class="row">
          <s:label class="rowLabel" name="Line 1*"/>
          <s:text name="address.line1" value="${address.line1}" class="rowText"/>
        </div>
        ...
        <div class="row">
          <s:label class="rowLabel" name="Line 2"/>
          <s:text name="address.line2" value="${address.line2}" class="rowText" id="line2"/>
        </div>
        ...
        <div class="row">
          ...
          <s:text name="address.city" value="${address.city}" class="rowText"/>
        </div>
        ...
        <div class="row">
          ...
          <s:text name="address.state" value="${address.state}" class="rowText"/>
        </div>
        ...
        <div style="float: right; font-size: 0.7em; width: 65%; margin-top: 10px;">
          <s:submit name="saveAddress" value="Update" class="button_orange"/>
        </div>
      </s:form>
    </div>
  </s:layout-component>
