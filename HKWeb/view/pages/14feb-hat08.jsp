...
<div class="cl"></div>
    ...
    <s:layout-render name="/layouts/embed/_productThumb200ny2013.jsp" productId='DIVO25' />
      ...
      <div class="cl"></div>
		<div class="pages">
            <a class="pages_link"  href="${pageContext.request.contextPath}/pages/14feb-hat07.jsp">Previous</a>
            ...
            <a class="pages_link" href="${pageContext.request.contextPath}/pages/14feb-hat06.jsp">6</a>
			...
			<a class="pages_link"  href="${pageContext.request.contextPath}/pages/14feb-hat09.jsp">Next</a>
         </div>
<div class="cl"></div>
