...
<div class="cl"></div>
    ...
    <s:layout-render name="/layouts/embed/_productThumb200ny2013.jsp" productId='SPT404' />
         ...
         <div class="cl"></div>
		<div class="pages">
	        <a class="pages_link"  href="${pageContext.request.contextPath}/pages/14feb-dump.jsp">Previous</a>
			<a class="pages_link" href="${pageContext.request.contextPath}/pages/14feb-dump.jsp">1</a>
