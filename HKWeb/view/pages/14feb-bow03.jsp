...
<div class="cl"></div>
    ...
    <s:layout-render name="/layouts/embed/_productThumb200ny2013.jsp" productId='H2O015' />
      ...
      <div class="cl"></div>
		<div class="pages">
            <a class="pages_link"  href="${pageContext.request.contextPath}/pages/14feb-bow02.jsp">Previous</a>

			<a class="pages_link" href="${pageContext.request.contextPath}/pages/14feb-bow.jsp">1</a>
			...
			<a class="pages_link"  href="${pageContext.request.contextPath}/pages/14feb-bow04.jsp">Next</a>
         </div>
<div class="cl"></div>
