...
<s:textarea name="order.userComments" id="userComments" rows="2" cols="20" class="newTextArea" placeholder="(e.g. preferred delivery time)"/>--%>
    ...
    <div class='right_container address_box'
         style="width: 245px;padding: 5px 10px;left: 40px;border: none;float: right;">
      ...
      <div class='title newTextHeading ' style="float: left;padding-bottom:5px;width: 100%;">
        ...
        <s:link beanclass="com.hk.web.action.core.user.SelectAddressAction" class="btn btn-gray"
                style="display: inline-block; float:right;font-size: 10px; ">
          CHANGE </s:link>
      </div>
