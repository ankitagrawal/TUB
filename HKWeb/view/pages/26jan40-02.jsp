...
<!--container01 close-->
      ...
      <div class="cl"></div>
		<div class="pages">
            <a class="next"  href="${pageContext.request.contextPath}/pages/26jan-40.jsp">← Previous</a>
			...
			<a class="next"  href="${pageContext.request.contextPath}/pages/26jan40-03.jsp">Next →</a>
         </div>
<div class="cl"></div>
