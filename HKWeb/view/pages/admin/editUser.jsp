...
<s:useActionBean beanclass="mhc.web.action.admin.EditUserAction" var="userBean"/>
...
<s:layout-render name="/layouts/defaultAdmin.jsp" pageTitle="Welcome">
  ...
  <s:layout-component name="content">
    <s:form beanclass="mhc.web.action.admin.EditUserAction" method="post">
      <s:errors/>
      ...
      Other Actions:
      <br/>
      <s:link beanclass="mhc.web.action.admin.ChangeUserRolesAction" event="pre">
        <s:param name="user" value="${userBean.user.id}"/>
        Change User Roles
      </s:link>
      <br/>
      <s:link beanclass="mhc.web.action.admin.ResetPasswordLinkAction" event="pre">
        <s:param name="user" value="${userBean.user.id}"/>
        Generate Reset Password Link
      </s:link>
      <br/>
      <s:link beanclass="mhc.web.action.admin.ChangeLoginPasswordAction" event="pre">
        <s:param name="user" value="${userBean.user.id}"/>
        Change Password
      </s:link>
      <br/>
      <s:link beanclass="mhc.web.action.admin.AssignWarehouseAction" event="pre">
        <s:param name="user" value="${userBean.user.id}"/>
