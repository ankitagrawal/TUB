    ...
    <%--<script type="text/javascript">--%>
        <%--$(document).ready(function () {--%>
                ...
                <%--$.getJSON(--%>
                        ...
                        <%--function (res) {--%>
                            <%--if (res.code == '<%=HealthkartResponse.STATUS_OK%>') {--%>
                                <%--var test = scannedVal;--%>
                                <%--var receivedLineItemId = res.data.lineItemId;--%>
                                <%--var extraCode = true;--%>
                                <%--$('.barcode-text').each(function (index) {--%>
                                    <%--var lineId = $(this).attr("lineItemId");--%>
                                    <%--var currentBarcode = $(this).val();--%>
                                    <%--if ((currentBarcode == null || currentBarcode == '') && lineId == receivedLineItemId) {--%>
                                        <%--extraCode = false;--%>
                                        <%--$(this).val(scannedVal);--%>
                                        <%--return false;--%>
                                    <%--}--%>
            ...
            <%--$('.download-link').live("click",function() {--%>
                ...
                <%--$.ajax({--%>
                    <%--url: href+"&scannedBarcodeList="+alreadyScannedCodeList+"&lineItem="+lineItemId,--%>
                    <%--error:function onError() {--%>
                        <%--alert('Error In Downloading barcode');--%>
                    <%--}--%>
                <%--});--%>
                <%--return true;--%>
            <%--});--%>
    ...
    <%--<c:if test="${rpw.reversePickupOrder != null}">--%>
        <%--<div class="margin-2">--%>
            <%--<s:form beanclass="com.hk.web.action.admin.reversePickup.RPWarehouseCheckinAction" class="mainform">--%>
                    ...
                    <%--<table class="rline-items">--%>
                        ...
                        <%--<c:forEach items="${rpw.reversePickupOrder.rpLineItems}" var="rplineitem" varStatus="ctr">--%>
                            ...
                            <%--<tr class="${prevLineId == currentLineId || ctr.first ? 'btm-dshed' : 'btm-solid'}">--%>
                                ...
                                <%--<td>${rplineitem.lineItem.sku.productVariant.product.name}</td>--%>
                                <%--<td>--%>
                                    ...
                                    <%--<c:forEach items="${customerReasonList}" var="reason">--%>
                                        ...
                                        <%--</c:if>--%>
                                    <%--</c:forEach>--%>
                                    <%--<s:hidden name="rpLineItems[${index}].customerReasonForReturn"--%>
                                              <%--value="${rpReturnId}"/>--%>
                                <%--</td>--%>
                                <%--<td>--%>
                                    <%--<s:text name="rpLineItems[${index}].itemBarcode"--%>
                                            <%--lineItemId="${rplineitem.lineItem.id}"--%>
                                            <%--class="barcode-text"/>--%>
                                ...
                                <%--</td>--%>
                                <%--<td>--%>
                                    <%--<s:link class="download-link"  lineItemId="${rplineitem.lineItem.id}"--%>
                ...
                <%--<div class="check-in">--%>
                    <%--<s:submit name="warehouseCheckIn" value="Check In"/>--%>
                <%--</div>--%>
            <%--</s:form>--%>
