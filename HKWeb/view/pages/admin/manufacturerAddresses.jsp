...
<s:useActionBean beanclass="web.action.admin.ManufacturerAddressAction" var="ma"/>
<s:layout-render name="/layouts/defaultAdmin.jsp">

  <s:layout-component name="content">

    <div>
      <s:form beanclass="web.action.admin.ManufacturerAddressAction" id="newAddressForm">
        <fieldset>
    ...
    <div class='left2' style="margin-left:20px; width: 100%;">
      <c:if test="${!empty ma.addresses}">
        <s:form beanclass="web.action.admin.ManufacturerAddressAction">
          <c:forEach var="address" items="${ma.addresses}" varStatus="addressCount" >
            <div class="address"
              ...
              <s:link beanclass="web.action.admin.ManufacturerAddressAction" event="remove" class="delete"
                      onclick="return confirm('Are you sure you want to delete this address?')">
                <s:param name="address" value="${address.id}"/>
                <s:param name="manufacturer" value="${ma.manufacturer.id}"/>
                (delete)
              </s:link>
              <s:link beanclass="web.action.admin.ManufacturerAddressAction" event="setAsDefaultAddress"
