...
<s:useActionBean beanclass="web.action.admin.DoomDayInventorySnapshotAction" var="ddis"/>
...
<s:layout-render name="/layouts/inventory.jsp" pageTitle="Search Batches for UPC/VariantID">
  ...
  <s:layout-component name="content">
    <div style="margin-top:100px" height="500px" align="center">
      <s:form beanclass="web.action.admin.DoomDayInventorySnapshotAction" autocomplete="off">
        <div id="savedVariant">
