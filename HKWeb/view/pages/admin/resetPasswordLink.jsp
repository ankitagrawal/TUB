...
<s:useActionBean beanclass="web.action.admin.ResetPasswordLinkAction" var="userBean" event="pre"/>
...
<s:layout-render name="/layouts/defaultAdmin.jsp" pageTitle="Welcome">
  ...
  <s:layout-component name="content">
    ...
    <s:useActionBean beanclass="web.action.admin.ResetPasswordLinkAction" var="userBean"/>
