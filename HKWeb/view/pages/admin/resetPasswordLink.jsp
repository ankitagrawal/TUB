...
<s:useActionBean beanclass="com.hk.web.action.admin.ResetPasswordLinkAction" var="userBean" event="pre"/>
...
<s:layout-render name="/layouts/defaultAdmin.jsp" pageTitle="Welcome">
  ...
  <s:layout-component name="content">
    ...
    <s:useActionBean beanclass="com.hk.web.action.admin.ResetPasswordLinkAction" var="userBean"/>
