...
<s:useActionBean beanclass="web.action.admin.EmailListByCategoryAction" event="pre" var="mailBean"/>
<s:layout-render name="/layouts/defaultAdmin.jsp" pageTitle="EmailListByCategoryAction">
    ...
    <s:layout-component name="content">
        <s:form beanclass="web.action.admin.EmailListByCategoryAction" method="get" renderFieldsPresent="false"
