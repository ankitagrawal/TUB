...
<s:useActionBean beanclass="web.action.admin.SupplierManagementAction" var="sma"/>
<s:layout-render name="/layouts/defaultAdmin.jsp" pageTitle="Supplier List">
  <s:layout-component name="content">

    <s:form beanclass="web.action.admin.SupplierManagementAction">
      <s:link beanclass="web.action.admin.SupplierManagementAction" class="buttons"
    ...
    <table class="zebra_vert">
      ...
      <c:forEach items="${sma.supplierList}" var="supplier">
        <tr>
          ...
          <td>
            <s:link beanclass="web.action.admin.SupplierManagementAction" event="createOrEdit">Edit
              <s:param name="supplier" value="${supplier.id}"/></s:link>
            &nbsp;
            <s:link beanclass="web.action.admin.CreatePurchaseOrderAction">Create PO
              <s:param name="supplier" value="${supplier.id}"/></s:link>
            &nbsp;
