...
<s:useActionBean beanclass="web.action.admin.InventoryCheckinAction" var="ica"/>
<s:layout-render name="/layouts/defaultAdmin.jsp" pageTitle="Inventory Checkin">
  ...
  <s:layout-component name="content">
    <div style="display:inline;float:left;">
      ...
      <s:form beanclass="web.action.admin.InventoryCheckinAction">
      ...
      <span style="display:inline;float:right;"><h2><s:link beanclass="web.action.admin.GRNAction">&lang;&lang;&lang;
