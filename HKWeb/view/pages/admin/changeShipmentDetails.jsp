                ...
                <c:if test="${csda.visible == true}">
                    <s:form beanclass="com.hk.web.action.admin.shipment.ChangeShipmentDetailsAction" id="newFormForAWB">
                        <fieldset>
                            ...
                            <s:select name="shipment.courier" value="${csda.shipment.courier}" class="text"
                                      id="courier">
                                <hk:master-data-collection service="<%=MasterDataDao.class%>"
                                                           serviceProperty="courierList" label="name"
                                                           value="id"/>
                            </s:select>
                            ...
                            <s:text name="shipment.awb.awbNumber" value="${csda.shipment.awb.awbNumber}"
                                    class="text fields" id="trackingId" style="width:170px" readonly="readonly"/>
                            ...
                            <s:text name="shipment.returnDate" class="date_input startDate text fields"
                                    style="width:160px"
                            ...
                            <s:select name="shippingOrder.orderStatus" value="${csda.shippingOrder.orderStatus}"
                                      class="text"
                                      style="width:170px" id="orderStatus">
                                <hk:master-data-collection service="<%=MasterDataDao.class%>"
                                                           serviceProperty="SOStatusForShipmentDetailsList"
                                                           label="name"
                                                           value="id"/>
                            </s:select>
