...
<s:layout-component name="content">
    ...
    <div align="left">
        ...
        <s:link beanclass="com.hk.web.action.admin.inventory.CycleCountAction" event="createCycleCount"
                style="float:right;">Brands to Exclude/Audit</s:link>
    </div>
    <s:form beanclass="com.hk.web.action.admin.queue.ChooseOrdersForPrintPickAction" method="get">
        ...
        <div align="center">
            ...
            <s:submit name="searchOrdersForPrinting" value="Search" style="font-size:0.9em"/>
        ...
        <div align="right" style="margin-bottom:20px;margin-right:50px;">
            ...
            <span onclick="javacript: $('#dateFilters').show()" style="cursor:pointer;font-size:1.1em;font-weight:bold;"
                  title="Expand">+</span>
            <span onclick="javacript: $('#dateFilters').hide()" style="cursor:pointer;font-size:1.1em;font-weight:bold;"
                  title="Collapse">-</span>
        </div>
        <div id="dateFilters" style="border:1px dotted #ccc; display:none;">
            <div align="center">
            ...
            <div align="center">
                <label>Target Start
                    Date </label><s:text class="date_input startDate" style="width:150px"
                                         formatPattern="<%=FormatUtils.defaultDateFormatPattern%>"
                                         name="startTargetDispatchDate"/>

                <label>Target End
                    Date </label><s:text class="date_input endDate" style="width:150px"
                                         formatPattern="<%=FormatUtils.defaultDateFormatPattern%>"
                                         name="endTargetDispatchDate"/>
