...
<s:useActionBean beanclass="web.action.admin.AddRewardPointAction" event="pre" var="rpBean"/>
...
<s:layout-render name="/layouts/defaultAdmin.jsp" pageTitle="Add Reward Point">
  ...
  <s:layout-component name="content">
    <s:form beanclass="web.action.admin.AddRewardPointAction" method="post">
