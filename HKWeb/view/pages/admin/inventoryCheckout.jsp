...
<s:useActionBean beanclass="web.action.admin.InventoryCheckoutAction" var="icBean"/>
  ...
  <s:layout-component name="content">
          ...
          <c:when test="${icBean.upc == null}">
            <fieldset class="top_label">
              ...
              <div style="width:450px">
                <s:form beanclass="web.action.admin.InventoryCheckoutAction" method="get" autocomplete="false">
                  <ul>
            ...
            <div><s:link beanclass="web.action.admin.InventoryCheckoutAction" style="font-size:1.2em;">
              &lang;&lang;&lang;Back
    ...
    <div style="display:inline;float:right;">
      <div style="display: none;">
        <s:link beanclass="web.action.admin.InventoryCheckoutAction" id="upcUpdateLink" event="updateUPC"></s:link>
      </div>
          ...
          <tr class="productVariantRow">
            ...
            <c:choose><c:when
              ...
              <td title="Click to fing SKU Groups/Batch">
                <s:link beanclass="web.action.admin.InventoryCheckoutAction" event="findSkuGroups">
                  ${productVariant.id}
