...
<s:useActionBean beanclass="web.action.admin.CreateEditComboAction" var="comboAction"/>
<s:layout-render name="/layouts/defaultAdmin.jsp">
  ...
  <s:layout-component name="content">
    <div style="display: none;">
      <s:link beanclass="web.action.admin.CreateEditComboAction" id="productInfoLink"
              event="getProductDetails"></s:link>
    </div>
    <s:form beanclass="web.action.admin.CreateEditComboAction">
          ...
          <table border="1" id="productTable">
            ...
            <c:forEach var="productDto" items="${comboAction.comboProductAndAllowedVariantsDtoList}" varStatus="ctr">
              <tr count="${ctr.index}" class="${ctr.last ? 'lastRow':''} productRow">
                ...
                <td>
                  <s:link beanclass="web.action.admin.CreateEditComboAction" event="deleteComboProduct">
