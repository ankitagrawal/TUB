...
<s:useActionBean beanclass="web.action.admin.SMSHomeAction" var="smsHome" event="pre"/>
...
<s:layout-render name="/layouts/defaultAdmin.jsp" pageTitle="SMS Home">
  ...
  <s:layout-component name="content">
    ...
    <s:form beanclass="web.action.admin.SMSHomeAction" method="get" autocomplete="false">
