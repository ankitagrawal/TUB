...
<s:useActionBean beanclass="com.hk.web.action.admin.user.SearchB2BUserAction" event="pre" var="userBean"/>
...
<s:layout-render name="/layouts/defaultAdmin.jsp">
  ...
  <s:layout-component name="heading">Search B2B User</s:layout-component>
  <s:layout-component name="content">


    <s:form beanclass="com.hk.web.action.admin.user.SearchB2BUserAction" method="get" renderFieldsPresent="false" renderSourcePage="false">
      <fieldset class="top_label">
        <ul>
          <div class="grouped">
            <li><label>Id </label> <s:text name="userFilterDto.id"/></li>
            <li><label>Login Id </label> <s:text name="userFilterDto.login"/></li>
