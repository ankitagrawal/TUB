        ...
        <s:form beanclass = "com.hk.web.action.admin.roles.AddRolePermissionAction" >
            ...
            <fieldset id = "addRole">
                <div class = "new role">
                    ...
                    <s:submit style="float:left;" name="saveRoleAndPermission" value="save" id="saveRole"/>
                </div>
            </fieldset>
            ...
            <fieldset id = "addPermission">
                <div class = "new permission">
                    ...
                    <s:submit style="float:left;" name="saveRoleAndPermission" value="save" id="savePerm"/>
                </div>
            </fieldset>
