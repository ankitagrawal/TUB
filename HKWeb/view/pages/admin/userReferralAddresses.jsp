...
<s:layout-render name="/layouts/defaultAdmin.jsp" pageTitle="Welcome">
  <s:layout-component name="content">
    <s:useActionBean beanclass="web.action.admin.UserReferrralsAddressesAction" var="addressBean"/>
    <s:form beanclass="web.action.admin.UserReferrralsAddressesAction" method="post">
