...
<s:layout-render name="/layouts/defaultAdmin.jsp">
    ...
    <s:layout-component name="content">
        ...
        <s:form beanclass="com.hk.web.action.admin.user.SearchUserAction" method="get" renderFieldsPresent="false"
                ...
                <ul>
                    ...
                    <div class="grouped">
                        <li><label>Create Date From: </label>
                            <s:text name="userFilterDto.createDateFrom" class="date_input"
                                    formatPattern="<%=FormatUtils.defaultDateFormatPattern%>"/>
                        </li>
                        <li><label>To</label>
                            <s:text name="userFilterDto.createDateTo" class="date_input"
                                    formatPattern="<%=FormatUtils.defaultDateFormatPattern%>"/>
                        </li>
                        <li><label>Last Login Date From: </label>
                            <s:text name="userFilterDto.lastLoginDateFrom" class="date_input"
                                    formatPattern="<%=FormatUtils.defaultDateFormatPattern%>"/>
                        </li>
                        <li><label>To</label>
                            <s:text name="userFilterDto.lastLoginDateTo" class="date_input"
                                    formatPattern="<%=FormatUtils.defaultDateFormatPattern%>"/>
                        </li>
                    </div>
                </ul>
            ...
            <c:forEach items="${userBean.userList}" var="user" varStatus="userCount">
                ...
                <td>
                    ...
                    <c:if test="${!fn:contains(user.roles,B2bUser)}">
                        <s:link beanclass="com.hk.web.action.admin.user.EditUserAction" event="activateB2bUser">
                            <s:param name="user" value="${user}"/>
                            [Activate B2bUser]
                        </s:link>
                    </c:if>
