...
<s:useActionBean beanclass="com.hk.web.action.admin.AssignWarehouseAction" var="userBean" event="pre"/>
...
<s:layout-render name="/layouts/defaultAdmin.jsp" pageTitle="Welcome">
  ...
  <s:layout-component name="content">
    ...
    <s:useActionBean beanclass="com.hk.web.action.admin.AssignWarehouseAction" var="userBean"/>
    Name: ${userBean.user.name}<br/>
    Login: ${userBean.user.login}<br/>
    <s:form beanclass="com.hk.web.action.admin.AssignWarehouseAction" method="post">
      <h2>Warehouses:</h2>
