...
<s:layout-render name="/layouts/defaultAdmin.jsp" pageTitle="GRN For PO Already Exist Check">
  ...
  <s:layout-component name="content">
    <s:useActionBean beanclass="com.hk.web.action.admin.POAction" var="poBean"/>
    <div align="center">
    ...
    <br/> <br/> <br/>
    <s:link beanclass="com.hk.web.action.admin.POAction" event="pre" class="button_green" style="background:gray; padding:2px; font-size:.9em">
      No, I'll use the same one
    </s:link>

    <s:link beanclass="com.hk.web.action.admin.POAction" event="generateGRN" class="button_green">
