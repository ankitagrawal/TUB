                    ...
                    <form id="sendCouponForm">
    					<div class="nRow">
                          ...
                          <p style="margin-top:5px;">
                              <s:link beanclass="com.hk.web.action.core.user.RequestCallbackAction" id="sendCouponLink" event="getContact">
                              <img src="images/submit.jpg" class="submitBtnRed" alt="send coupon"> </s:link>
