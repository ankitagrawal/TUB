...
<s:layout-component name="htmlHead">
    ...
    <div class="greenBx" id="rMenu">
    			<div class="yellowBx" id="ttf"><a href="javascript:void(0)" onclick="beforeCls()"  class="closeBtn">&nbsp;</a>
    				<div class="pad1Form">
                    <form id="sendCouponForm" action="${pageContext.request.contextPath}/core/user/RequestCallback.action"
                          method="post">
    					<div class="nRow">
                          ...
                          <p>Phone Number</p>
                          <p><input type="text" name="phone" class="bgFormInputs" id ="phone"/></p>
                          <p>Email address</p>
                          <p><input type="text" name="email" class="bgFormInputs" id="email"/></p>
                          <div class="nRow">
                          	<div class="bgFormCBArea"><input name="" type="checkbox" value="" /></div>
                            <div class="bgFormCBMsgArea">I would like to receive updates/ new offers from HealthKart.com in future through Phone/SMS/E-Mails.</div>					<div class="cl"></div>
                          </div>
                          <p style="margin-top:5px;">
                              <button type="submit" name="getContact" onclick="return _validation()">
    	...
    	<div class="nRow pageHeadImg1"><img src="images/the-three-pillars-of-bodybuilding.jpg" alt="THE 3 PILLARS OF BODYBUILDING"/></div>
        <div class="nRow pageHeadImg2"><img src="images/you-should-never-compromise-on.jpg" alt="You shouldnever compromise on" /></div>
        <div class="nRow">
        	<h1>One fine day, you decide that enough is enough. You need to get into shape and fast.<span> Fast and how? You go to the gym and start with whatever you can get your hands on. Fact is, you end up doing far more harm than good to yourself. Ladies and gentlemen, here are three tenets of exercising that you should never ever take lightly</span></h1>
        </div>
        ...
        <div class="nRow">
        	<div class="leftBar">
            	<p class="paraGp1">If everything that you do at the gym produces no results, then in all <br />probability, you are the common <br />denominator. Consider it a huge <br />mismatch between your set of goals and<br /> the kind of exercise you are undertaking-<br /> they are perfect on their own but just <br />don’t complement each other.</p>
                <p>Both strength training and cardio yield<br />excellent results when your goal is as<br />simple as weight loss.</p>
                <p>But with levels going up from beginner to<br /> even as little as an advanced-beginner<br />and intermediate, expert guidance<br />becomes a necessity. Because on your<br /> own, you just can’t tell where the finish<br /> line is or if you even came close to it.</p>
            </div>
            <div class="centerBar">
            	<p>Why do you need expert guidance for exercise?</p>
                <p>Weight loss leads to sagging skin. <br />Unguided exercise regimes target only<br />the broad goal of weight loss but miss on<br />the target of keeping the skin from<br /> sagging.</p>
                <p>Toning requires a reasonable amount of strength and resistance training. <br />Needless to say, a freehand approach will <br />only leave you either using more weight<br />than you can handle or less than you can<br />actually pull off. In either case, your<br /> muscles pay dearly.</p>
                <p>Bulking up doesn’t happen for anyone without the unique, body-specific <br />exercise patterns. Measurements like<br />BMI, body fat ratio and individual <br />metabolic rates differ for each person.</p>
            </div>
            <div class="rightBar">
            	<p class="paraGp1">And it is these that direct which exercises<br />you must incorporate and what level.</p>
                <p class="paraGp1">Expert guidance helps you avoid common mistakes like overdoing cardio for weight loss. That not only leads to muscle loss <br />but also slows down weight loss. You <br />must have a moderation level for any exercise you do. It might look easy but <br />you can’t get there all by yourself by <br />making such mistakes and ultimately hampering the very goal you started with.</p>
    ...
    are short of time. But are they any match to the whole foods? Not really."/></p>
     	...
     	<div class="nRow">
        	<div class="leftBar">
            	<div class="supplementPic1"><img src="images/muscleblaze-whey-protein.png" alt="MuscleBlase Whey Protein" /></div>
            ...
            <div class="rightBar">
            	<div class="supplementPic4"><img src="images/weider-pure-creatine.png" alt="Weider Pure Creatine" /></div>
                <div class="supplementPic5"><img src="images/muscletech-nitro-tech.png" alt="Muscletech Nitro Tech" /></div>
