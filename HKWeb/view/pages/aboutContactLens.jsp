...
<s:layout-render name="/layouts/default.jsp">
  ...
  <s:layout-component name="heading">
    <h1 class="orange strikeline">Contact Lens FAQs</h1>
  </s:layout-component>
  <s:layout-component name="left_col">
        <div>

          <p>
          <form name="faqForm" method="get" action="aboutContactLens.jsp"><input
        ...
        <%
          int sNo = 0;
          List<FAQ> faqList = (new FAQAction()).getFAQs(searchString, "Eye");
