...
<s:layout-render name="/layouts/embed/_productThumb200ny2013.jsp" productId='SENERA6' />
         ...
         <div class="cl"></div>
		<div class="pages">
            <a class="pages_link"  href="${pageContext.request.contextPath}/pages/14feb-nurse02.jsp">Previous</a>

			<a class="pages_link" href="${pageContext.request.contextPath}/pages/14feb-nurse.jsp">1</a>

            <a class="pages_link" href="${pageContext.request.contextPath}/pages/14feb-nurse02.jsp">2</a>
