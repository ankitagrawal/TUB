...
<s:layout-definition>
    ...
    %>
        <c:if test = "${pageType == 'category' ||  pageType == 'product'}">
            <c:if test = "${(topLevelCategory == 'sports-nutrition') || (topLevelCategory == 'diabetes') || (topLevelCategory == 'health-nutrition') ||  (topLevelCategory == 'eye') ||  (topLevelCategory == 'parenting')}">
