...
(function(){
	...
	var options= {
		assetURL:'',
		loadingImage:'../yui/assets/skins/sam/loading.gif',
		animate:true,
		animSequence:'wh',
		flvPlayer:'/_inc/js/shadowbox/flvplayer.swf',
		overlayColor:'#000',
		overlayOpacity:0.85,
	...
	skin:{
		...
		'<a href="javascript:Shadowbox.close();">Close</a>'+
		'</div>',
		next:'<div id="shadowbox_nav_next">'+
		'<a href="javascript:Shadowbox.next();"></a>'+
		'</div>',
		prev:'<div id="shadowbox_nav_previous">'+
		'<a href="javascript:Shadowbox.previous();"></a>'+
		'</div>'
	},
	ext:{
