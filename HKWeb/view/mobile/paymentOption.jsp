...
<div id='defaultViewContent' class=viewContent>
   ...
   <div id=accord>
   <div class=accordCont><h3>Cash On delivery</h3><div><pre><h2>Order Total</h2>Order Total Rs. 428.00
...
<a href='orderSuccess.jsp' class=ad2Crt>Confirm</a>
   ...
   <div class=accordCont><h3>Credit Card</h3>
   <div>
   Coming Soon
   </div>
   </div>
   <div class=accordCont><h3>Net Banking</h3>
   <div>
   Coming Soon
   </div>
   </div>
   <div class=accordCont><h3>Cheque Payment</h3>
   <div>
   Coming Soon
   </div>
   </div>
