...
<div id="login-header"><h2 style='color:#2186C6;font-weight:normal'>Contact Us</h2>
 <!-- block -->
<div id="signin-block" style='margin:0px 10px'>
 ...
 <p style="padding:10px 0 10px 0"> 
  ...
  <!--label for="passwordsignup">Phone/Mobile <span>*</span></label-->
   <textarea type="text" placeholder="Your Query/Feedback"  name="password" id="passwordsignup"></textarea>
                                </p>
...
<script>
$('#contactUs').bind('pageshow',function(){
