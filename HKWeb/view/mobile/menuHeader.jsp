...
<table class='menuContainer'><tr><td><img src='images/logo.png' style='position:relative;top:3px;left:3px'/></td><td>
<div class=sessionOptions><b>Hi <%=(session.getAttribute("userName")!=null?session.getAttribute("userName"):"Guest")%> 
</b><br><%=(session.getAttribute("userName")!=null?"<a href='javascript:void(0)' onclick='javascript:logout()' style='text-decoration:none'>Logout</a>":"<a href='login-signup.jsp' style='text-decoration:none'>Login | Signup</a>")%></div></td></tr></table>
<script>
