[ATTENTION] Inventory of Variant [${productVariant.id}] in REDZONE
<html>
<head>
  <title>[ATTENTION] Inventory of Variant [${productVariant.id}] in REDZONE</title>
</head>
<body>
<#include "header.ftl">
...
<p>
  Inventory of Variant ${productVariant.id} is running low. Please get it replenished ASAP.
</p>
