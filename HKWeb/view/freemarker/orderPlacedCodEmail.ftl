...
<p style="margin-bottom:1em">
  Thanks for placing an order with us. We have received the order and will give you a call shortly to confirm it.
  Please note that COD orders will not be confirmed and shipped from our end until we manually confirm the order on the phone number provided.
