...
<#include "headerBeta.ftl">
    ...
    <tr>
        <td colspan="2" style="margin-top:10px;margin-bottom:1em">
            Thanks for placing an order with us.
            <br/>Your order is pending verification. Please give a missed call on 0124-4616414 to verify the order
            automatically.
            Please note you can only verify by calling from the number that you have given as COD contact
            number ${order.address.phone}. In case you are unable to give the missed call, our customer care will
            call you
            on the COD contact number.
            Please note that COD orders will be processed and shipped from our end only after the order is verified.
            Thanks for your patience.
        </td>
    </tr>
    <tr>
        <td style="margin-top:10px;margin-bottom:1em">Here are your order details for the order
    ...
    <tr>
        <td colspan="2" style="padding-top:10px;margin-bottom:1em">
    ...
    <tr>
        <td style="padding-top:10px;margin-bottom:1em" colspan="2">We will send you an email as soon as your order is
            shipped.
        </td>
    </tr>

    <tr>
        <td colspan="2" style="padding-top:10px;margin-bottom:1em"><strong>HealthKart.com</strong></td>
    </tr>
    </tbody>
