...
<p style="margin-bottom:1em">
    ...
    <br/>Your order is pending verification. Please give a missed call on 0124-4616414 to verify the order automatically.
    Please note you can only verify by calling from the number that you have given as COD contact number ${order.address.phone}. In case you are unable to give the missed call, our customer care will call you on the COD contact number.
