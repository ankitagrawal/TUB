  ...
  <tr>
    <td align="center" valign="top">
      <table width="500" border="0" cellspacing="0" cellpadding="0" align="center"
            ...
            <table width="500" border="0" cellpadding="0" cellspacing="0">
              ...
              <tr>
                <td colspan="5"><a href="http://www.healthkart.com"><img
                        src="http://img.healthkart.com/email/miss_you_emailer_new/images/main_banner.jpg" width="500"
                        height="148" alt="You are that close to our heart! We miss you." border="0"/></a></td>
              </tr>
        ...
        <tr>
          <td width="579" valign="top">Hi <#if user??>${user.name}!</#if><br/>
            <br/>


            Its been so long since you last visited. We miss you.<br/>
            <br/>

            Maybe you are busy. Maybe we screwed up the last time you ordered. We would like to make it up to you & win
            you back in style.<br/>
            <br/>

            So here is an exclusive discount coupon for you.
            <br/>
            Coupon Code: ${coupon.code}
            <br/>
            Benefits: ${coupon.offer.description}
            <br/>
