${product_name}. Hurry, stock running out 
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td><table width="500" border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td colspan="5"><a href="http://www.healthkart.com?utm_source=abandonedCartReminder&utm_medium=email&utm_campaign=abandonedCart_nutrition_s2_${product_id}"><img src="http://img.healthkart.com/email/abandoned_cart_emailer_new/images/main_banner.jpg" width="500" height="148" alt="You were almost there! Still waiting for you..." border="0" /></a></td>
      </tr>
              ...
              <tr>
                ...
                <td width="306" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    ...
                    <td>&nbsp;</td>
                    <td align="center" valign="middle" bgcolor="#3379bb" style="color:#FFFFFF; font-weight:bold;" height="25px"><a href="${product_url}?utm_source=abandonedCartReminder&utm_medium=email&utm_campaign=abandonedCart_nutrition_s2_${product_id}" style="color:#FFFFFF; text-decoration:none;">Buy Now</a></td>
                  </tr>
