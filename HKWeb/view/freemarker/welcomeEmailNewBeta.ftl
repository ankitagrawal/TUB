    ...
    <table width="530" border="0" align="center" cellpadding="0" cellspacing="0">
        ...
        <tr>
            <td style="padding-bottom:10px" colspan="2" align="left" valign="top">You can login to see your order history, track previous orders and see
                the
        ...
        <tr>
            <td colspan="2" align="center"
                style="padding-top:10px; padding-bottom:10px; font-family:Georgia, 'Times New Roman', Times, serif; font-size:11px; line-height:18px; padding-top:10px;color:#646464;">
