...
Your order, dated ${order.payment.paymentDate}, for INR ${pricingDto.grandTotalPayable}, with order confirmation number ${order.gatewayOrderId} is being processed. The following items will be shipped shortly:<br />
<br/>
...
If you have any questions, you can chat online with our Customer Care or call them at 0124-4551616 . We will send another email once your order ships.<br />
  <br />
