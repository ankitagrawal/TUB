...
<head>
  ...
  <title>Refer more! Earn more...</title>
</head>
  ...
  <tr>
    <td align="center" valign="top">
      <table width="500" border="0" cellspacing="0" cellpadding="0" align="center"
            ...
            <table width="500" border="0" cellpadding="0" cellspacing="0">
              ...
              <tr>
                <td colspan="5"><a href="http://www.healthkart.com"><img
                        src="http://img.healthkart.com/email/refferal_reward_emailer_new/images/main_banner.jpg"
                        width="500" height="148" alt="Refer more! Earn more..." border="0"/></a></td>
              </tr>
        ...
        <tr>
          <td width="579" valign="top">Hi ${rewardPoint.user.firstName}<br/>
            <br/>


            Thank you for referring ${rewardPoint.referredUser.name} to us as a customer.<br/>
            <br/>

            As a token of appreciation, we would like to offer you Rs${rewardPoint.value}. <br/>
            <br/>
