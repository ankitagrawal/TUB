      ...
      <table width="500" border="0" cellspacing="0" cellpadding="0" align="center"
            ...
            <table width="500" border="0" cellpadding="0" cellspacing="0">
              ...
              <tr>
                <td colspan="5"><a href="http://www.healthkart.com"><img
                        src="http://img.healthkart.com/email/abandoned_cart_emailer_new/images/main_banner.jpg"
                        width="500" height="148" alt="You were almost there! Still waiting for you..." border="0"/></a>
                </td>
              </tr>
        ...
        <tr>
          <td width="579" valign="top">Hi ${user.name}!<br/>
            ...
            On your last visit, you had created a cart with the following items: <br/>
            <table style="font-size:12px;" cellpadding="5" cellspacing="0" border="1">
              ...
              <tr>
                ...
                <td>${productLineItem.productVariant.product.name}<br/>
                  <#list productLineItem.productVariant.productOptions as productOption>
                ...
                <td>
                  <span style="text-decoration: line-through;">${productLineItem.markedPrice}</span> ${productLineItem.hkPrice}
                </td>
                <td>
                  ${productLineItem.hkPrice * productLineItem.qty}
                </td>
            ...
            In case you are still interested, here’s a discount coupon ${coupon.code} that you can use to get benefits
            : ${coupon.offer.description}. You can use this upto ${coupon.endDate}. See you!<br/>
            <br/>
      ...
      <table width="500" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
          <td height="70" colspan="3" align="left" valign="middle"><a href="http://www.healthkart.com/"><img
                  src="images/hk_logo_bw.jpg" alt="HealthKart.com logo" width="178" height="28" border="0"/></a></td>
