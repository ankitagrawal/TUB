Some items of your order ${order.gatewayOrderId} have been shipped.
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
  <meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
  <title>Partial Dispatch</title>
</head>
  ...
  <tr>
    <td align="center" valign="top">
      <table width="500" border="0" cellspacing="0" cellpadding="0" align="center"
        ...
        <tr>
          <td width="579" valign="top">Hi ${order.address.name}!<br/>
            <br/>


            Your order number ${order.gatewayOrderId} on date ${order.payment.paymentDate} is being processed. In the
            interest of time, we are shipping the following items early:<br/>
            <br/>
            <table style="font-size:12px;" cellpadding="5" cellspacing="0" border="1">
              ...
              <tr>
                ...
                <td>${lineItem.productVariant.product.name}<br/>
                  <#list lineItem.productVariant.productOptions as productOption>
            ...
            The following items are being processed at the moment:<br/>
             <br/>
            <table style="font-size:12px;" cellpadding="5" cellspacing="0" border="1">
              <td><strong>Item</strong></td>
              <td><strong>Quantity</strong></td>
            ...
            our Customer Care or call them at 0124-4551666 .<br/>
            <br/>
