...
<p style="margin-bottom:1em">
    Thanks for placing an order with us. We have received the order but the payment authorization is currently pending
    from the payment gateway.
    This happens sometimes when the payment gateway does not receive a real time response from the bank about the status
