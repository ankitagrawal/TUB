Your order ${order.gatewayOrderId} has been Installed !
		...
		<table width="500" border="0" cellspacing="0" cellpadding="0" align="center"
			...
			<tr>
				<td width="579" valign="top">Dear ${order.user.name}<br/> <br/>
					...
					Your Order No.: ${order.gatewayOrderId} has been successfully Installed.<br/><br/>
					...
					<br/> <br/>
					Reach our Customer Care at 0124-4551666.
					<br/>
