...
<table width="530" border="0" align="center" cellpadding="0" cellspacing="0">
    <thead width="500">
            <tr>
                <th width="222"><a href="http://www.healthkart.com"><img
                        src="${hkLogo}" alt="HealthKart.com Logo" width="207"
                        height="60" border="0"/></a></th>
                <th width="15" style="border-left: solid 1px #999999"></th>
                <th width="245" align="left" style="font-size:13px; font-weight:bold; color:#666666"><a
            ...
            <tr>
                <th colspan="4"><a href="http://www.healthkart.com"><img
    ...
    <tbody width="500" align="center" style="font-size:13px; line-height:1.75em;">
        <tr>
            <td height="20"></td>
        </tr>
        <tr>
    ...
    <tfoot style="border-top: solid #0000ff 1px;"  width="500" align="center">
            <tr>
