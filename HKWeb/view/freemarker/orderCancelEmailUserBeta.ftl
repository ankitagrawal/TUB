...
<#include "headerBeta.ftl">
    ...
    <tr>
        <td style="margin-bottom:1em" colspan="2">We have cancelled your order id ${order.gatewayOrderId}.</td>
    </tr>
    <tr>
    ...
    <tr>
        <td style="margin-bottom:1em; padding-bottom: 10px"><strong>HealthKart.com</strong></td>
    </tr>
    </tbody>
