Purchase Order # ${purchaseOrder.id} Dt. <${.now?date}> for C/o ${purchaseOrder.supplier.name} from Bright Lifecare Pvt. Ltd.
<html>
<head>
...
<p style="margin-top: 2px;margin-bottom: 2px;margin-left: 2px;">8. Kindly ship the goods to our warehouse address as follows - <p style="margin-top: 2px;margin-bottom: 2px;margin-left: 2px;font-weight: bold;">${warehouseName}:</p>${warehouseAddress}</p>
<br/>
<br/>
