...
Ember.TEMPLATES["templates/offerTopTextBeta"] = Ember.Handlebars.template(function anonymous(Handlebars,depth0,helpers,partials,data) {
this.compilerInfo = [2,'>= 1.0.0-rc.3'];
helpers = helpers || Ember.Handlebars.helpers; data = data || {};
  var stack1, hashTypes, escapeExpression=this.escapeExpression, self=this;
...
HK.OfferTopTextView = Ember.View.create({
    templateName:"templates/offerTopTextBeta",
    controllerBinding:"HK.CartOfferController"
});
