...
<s:useActionBean
	beanclass="com.hk.web.action.admin.warehouse.SelectWHAction"
	var="whAction" event="getUserWarehouse" />
<shiro:hasAnyRoles name="<%=RoleConstants.ROLE_GROUP_ADMINS%>">
	<div class="menuBar adminMenuBar" style="width: 100%; margin: 0px;">
		<ul class='lvl1'>
			<li class='lvl1 menuItem trimPadding' title=""><a
				href="${pageContext.request.contextPath}/pages/admin/adminHome.jsp">Admin
					Home</a></li>
			<c:choose>
				<c:when test="${whAction.setWarehouse == null}">
					<li class='lvl1 menuItem trimPadding' title=""><s:link
							class="invert"
			...
			<li class='lvl1 menuItem trimPadding' title=""><a
				href="${pageContext.request.contextPath}/pages/admin/courier/courierAdminHome.jsp">OPS</a>
			</li>
			<li class='lvl1 menuItem trimPadding' title=""><a
				href="${pageContext.request.contextPath}/pages/admin/categoryAdminHome.jsp">Category</a>
			</li>
			<li class='lvl1 menuItem trimPadding' title=""><s:link
					class="invert"
					beanclass="com.hk.web.action.admin.user.SearchUserAction">Search Users</s:link></li>
			...
			<li class='lvl1 menuItem trimPadding' title=""><s:link
					class="invert" beanclass="com.hk.web.action.report.ReportAction">Report Manager</s:link></li>
	...
	<c:if test="${whAction.setWarehouse != null}">
		<div align="center" class="prom yellow help"
			style="height: 16px; font-size: 16px; color: red; font-weight: bold;">
			ATTENTION: Selected Warehouse -> ${whAction.setWarehouse.name}</div>
	</c:if>
	<div class="right"></div>
