...
<s:layout-definition>
 ...
 <div class="clear"></div>
    ...
    <div class="offerAndBrands">
      <div style="float:left"><s:link href='/resources' rel="nofollow">HealthMag&nbsp;</s:link></div><div style="float:left; margin-right: 12px;"><s:link href='/resources' rel="nofollow"><img src="<hk:vhostImage/>/images/resources_16.png"></s:link></div>
      ...
      <div style="float:left"><a href='http://www.healthkartplus.com?src=hk' rel="nofollow" target='_blank' style="color:#000;">HealthKartPlus&nbsp;</a></div><div style="float:left;"><a href='http://www.healthkartplus.com?src=hk' rel="nofollow" title="HealthKartPlus.com"><img src="${pageContext.request.contextPath}/images/hkp-favicon.jpg"></a></div>
      <div style="float:left; margin-right: 15px;">&nbsp;&nbsp;&nbsp;<s:link href='${pageContext.request.contextPath}/core/loyaltypg/LoyaltyIntroduction.action' rel="nofollow" target="_blank"
