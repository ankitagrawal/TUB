...
<%--       <div style="float:left"><s:link href='/resources'>HealthMag&nbsp;</s:link></div><div style="float:left; margin-right: 15px;"><s:link href='/resources'><img src="<hk:vhostImage/>/images/resources_16.png"></s:link></div>
 --%>
      <div style="float:left; margin-right: 15px;"><s:link beanclass='com.hk.web.action.core.loyaltypg.LoyaltyIntroductionAction' ><img style="height: 20px;" src="<hk:vhostJs/>/pages/loyalty/resources/images/stellarView.jpg"></s:link></div>
