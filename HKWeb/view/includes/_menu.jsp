...
<s:layout-definition>
  ...
  <script type="text/javascript">
    ...
    <%
      ...
      Date endOfOfferDate = new Date(new DateTime(2012, 10, 28, 23, 59, 59, 59).getMillis());
    ...
    <div class="siteNotice" style="width:960px; margin-left:auto; margin-right:auto;">
        <div style="height: 48px; padding-top: 6px; font-size: 1em; color: black; background-color: yellow;">
            <strong>Pre Diwali Weekend Discount!</strong> 10% CashBack Sitewide* (only on prepaid orders above Rs 1000, TnC apply), Use Coupon Code <strong>HKPREDIWALISALE</strong><br/>
