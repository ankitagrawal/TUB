 ...
 <div class="clear"></div>
  <div id="logoBoxContainer" style="cursor:default; width: 960px; margin: 35px auto 7px;">
    ...
    <div class="offerAndBrands">
      ...
      <div style="float:left; margin-right: 15px;">&nbsp;<s:link href='${pageContext.request.contextPath}/core/loyaltypg/LoyaltyIntroduction.action' target="_blank"><img style="height: 20px;" src="${pageContext.request.contextPath}/pages/loyalty/resources/images/stellarView.png"></s:link></div>
    </div>
