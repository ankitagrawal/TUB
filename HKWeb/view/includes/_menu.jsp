...
<%--       <div style="float:left"><s:link href='/resources'>HealthMag&nbsp;</s:link></div><div style="float:left; margin-right: 15px;"><s:link href='/resources'><img src="<hk:vhostImage/>/images/resources_16.png"></s:link></div>
 --%>
      <div style="float:left; margin-right: 15px;"><s:link href='${pageContext.request.contextPath}/core/loyaltypg/LoyaltyIntroduction.action' target="_blank"><img style="height: 20px;" src="${pageContext.request.contextPath}/pages/loyalty/resources/images/stellarView.jpg"></s:link></div>
